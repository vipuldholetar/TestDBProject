CREATE TABLE [dbo].[RefPromotion] (
    [RefPromotionID] INT           IDENTITY (1, 1) NOT NULL,
    [PromotionName]  VARCHAR (255) NOT NULL,
    [CreatedDT]      DATETIME      NOT NULL,
    [CreatedByID]    INT           NOT NULL,
    [ModifiedDT]     DATETIME      NULL,
    [ModifiedByID]   INT           NULL,
    CONSTRAINT [PK_RefPromotion] PRIMARY KEY CLUSTERED ([RefPromotionID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefPromotion_AuditTrail] ON [dbo].[RefPromotion] 
