CREATE TABLE [dbo].[CreativeDetailStagingONV] (
    ...
    [CreatedDT]               DATETIME       CONSTRAINT [DF_CreativeDetailStagingONV_CreateDTM] DEFAULT (getdate()) NOT NULL,
    [ModifiedDT]              DATETIME       NULL,
    [Height]                  INT            NULL,
    [Width]                   INT            NULL,
    [MediaFileName]           VARCHAR (500)  NULL,
    [MediaIrisAssetName]      VARCHAR (100)  NULL,
    CONSTRAINT [PK_CreativeDetailStagingONV] PRIMARY KEY CLUSTERED ([CreativeDetailStagingID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailStagingONV_AuditTrail] ON [dbo].[CreativeDetailStagingONV] 
...
SET @TableName = 'CreativeDetailStagingONV'
