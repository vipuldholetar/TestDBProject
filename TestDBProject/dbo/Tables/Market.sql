CREATE TABLE [dbo].[Market] (
    ...
    [DisplayInMediaStreams]         INT            DEFAULT ((0)) NULL,
    [Promotion]                     VARCHAR (50)   NULL,
    [Brand]                         VARCHAR (50)   NULL,
    CONSTRAINT [PK_MARKETMASTER] PRIMARY KEY CLUSTERED ([MarketID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-LegacyMKTCOD]
    ON [dbo].[Market]([CTLegacyLMKTCODE] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Market_IDDesc]
    ON [dbo].[Market]([MarketID] ASC, [Descrip] ASC);


GO
CREATE TRIGGER [dbo].[Market_AuditTrail] ON [dbo].[Market] 
