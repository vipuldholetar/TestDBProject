CREATE TABLE [dbo].[ScanTracker] (
    [ScanTrackerID] INT          IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [UserID]        INT          NOT NULL,
    [ScanTrackDT]   DATETIME     CONSTRAINT [DF_ScanTracker_ScanTrackDt] DEFAULT (getdate()) NULL,
    [OccurrenceID]  BIGINT       NOT NULL,
    [ImageName]     VARCHAR (50) NOT NULL,
    CONSTRAINT [PK_ScanTracker] PRIMARY KEY CLUSTERED ([ScanTrackerID] ASC)
);


GO
CREATE TRIGGER [dbo].[ScanTracker_AuditTrail] ON [dbo].[ScanTracker] 
