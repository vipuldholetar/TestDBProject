CREATE TABLE [dbo].[RefTagline] (
    [RefTaglineID] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RefTagline] PRIMARY KEY CLUSTERED ([RefTaglineID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefTagline_AuditTrail] ON [dbo].[RefTagline] 
