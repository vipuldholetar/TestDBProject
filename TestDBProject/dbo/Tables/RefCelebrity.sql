CREATE TABLE [dbo].[RefCelebrity] (
    [RefCelebrityID] INT          IDENTITY (1, 1) NOT NULL,
    [CelebrityName]  VARCHAR (50) NOT NULL,
    [CreatedDT]      DATETIME     NOT NULL,
    [CreateByID]     INT          NOT NULL,
    [ModifiedDT]     DATETIME     NULL,
    [ModifiedByID]   INT          NULL,
    CONSTRAINT [PK_RefCelebrity] PRIMARY KEY CLUSTERED ([RefCelebrityID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefCelebrity_AuditTrail] ON [dbo].[RefCelebrity] 
