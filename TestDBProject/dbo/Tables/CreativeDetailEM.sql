CREATE TABLE [dbo].[CreativeDetailEM] (
    [CreativeDetailsEMID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailEM] PRIMARY KEY CLUSTERED ([CreativeDetailsEMID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_CreativeDetailEM_CreativeMasterId]
    ON [dbo].[CreativeDetailEM]([CreativeMasterID] ASC, [Deleted] ASC)
    INCLUDE([CreativeFileDate]);


GO
CREATE NONCLUSTERED INDEX [idx_CreatedDT]
    ON [dbo].[CreativeDetailEM]([CreatedDT] ASC)
    INCLUDE([CreativeDetailsEMID], [CreativeMasterID], [CreativeRepository]);


GO
CREATE TRIGGER [dbo].[CreativeDetailEM_AuditTrail] ON [dbo].[CreativeDetailEM] 
...
SET @TableName = 'CreativeDetailEM'
