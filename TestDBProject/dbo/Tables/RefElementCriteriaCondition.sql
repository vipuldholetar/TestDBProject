CREATE TABLE [dbo].[RefElementCriteriaCondition] (
    [ElementCriteriaConditionID] INT           IDENTITY (1, 1) NOT NULL,
    [ElementCriteriaID]          INT           NOT NULL,
    [CompoundORInd]              BIT           NOT NULL,
...
GO
CREATE TRIGGER [dbo].[RefElementCriteriaCondition_AuditTrail] ON [dbo].[RefElementCriteriaCondition] 
...
SET @TableName = 'RefElementCriteriaCondition'
