CREATE TABLE [dbo].[TVRecordingScheduleBA] (
...
GO
CREATE TRIGGER [dbo].[TVRecordingScheduleBA_AuditTrail] ON [dbo].[TVRecordingScheduleBA] 
...
SET @TableName = 'TVRecordingScheduleBA'
