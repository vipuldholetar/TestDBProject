CREATE TABLE [dbo].[AdvertiserIndustryGroup] (
    [AdvertiserIndustryGroupID] INT      IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([AdvertiserIndustryGroupID] ASC),
    CONSTRAINT [FK_AdvertiserIndustryGroup_REFIndustryGroup] FOREIGN KEY ([IndustryGroupID]) REFERENCES [dbo].[RefIndustryGroup] ([RefIndustryGroupID])
);


GO
CREATE TRIGGER [dbo].[AdvertiserIndustryGroup_AuditTrail] ON [dbo].[AdvertiserIndustryGroup] 
...
SET @TableName = 'AdvertiserIndustryGroup'
