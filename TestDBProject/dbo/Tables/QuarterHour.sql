CREATE TABLE [dbo].[QuarterHour] (
    [QuarterHourID] INT      NOT NULL,
    [StartTime]     TIME (7) NOT NULL,
    [EndTime]       TIME (7) NOT NULL,
    [CreatedDT]     DATETIME NOT NULL,
    CONSTRAINT [PK_QuarterHoursMaster] PRIMARY KEY CLUSTERED ([QuarterHourID] ASC)
);


GO
CREATE TRIGGER [dbo].[QuarterHour_AuditTrail] ON [dbo].[QuarterHour] 
