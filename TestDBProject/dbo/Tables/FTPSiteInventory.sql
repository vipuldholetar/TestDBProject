CREATE TABLE [dbo].[FTPSiteInventory] (
    ...
    CONSTRAINT [PK_FTPSiteInventory] PRIMARY KEY CLUSTERED ([CMSFileName] ASC)
);


GO
CREATE TRIGGER [dbo].[FTPSiteInventory_AuditTrail] ON [dbo].[FTPSiteInventory] 
...
SET @TableName = 'FTPSiteInventory'
