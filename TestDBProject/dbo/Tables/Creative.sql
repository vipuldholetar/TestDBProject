CREATE TABLE [dbo].[Creative] (
    ...
    CONSTRAINT [PK_CreativeMaster] PRIMARY KEY CLUSTERED ([PK_Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_Creative_AdIdPrimaryIndicator]
    ON [dbo].[Creative]([AdId] ASC)
    INCLUDE([PK_Id], [PrimaryIndicator]);


GO
CREATE TRIGGER [dbo].[Creative_AuditTrail] ON [dbo].[Creative] 
