CREATE TABLE [dbo].[ClearanceStatus] (
    [ClearanceStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]            VARCHAR (50)  NOT NULL,
    [Descrip]           VARCHAR (100) NULL,
    CONSTRAINT [PK_ClearanceStatus] PRIMARY KEY CLUSTERED ([ClearanceStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[ClearanceStatus_AuditTrail] ON [dbo].[ClearanceStatus] 
