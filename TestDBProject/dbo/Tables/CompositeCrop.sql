CREATE TABLE [dbo].[CompositeCrop] (
    [CompositeCropID]    INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CompositeCrop] PRIMARY KEY CLUSTERED ([CompositeCropID] ASC)
);


GO
CREATE TRIGGER [dbo].[CompositeCrop_AuditTrail] ON [dbo].[CompositeCrop] 
