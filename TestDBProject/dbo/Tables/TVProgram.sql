CREATE TABLE [dbo].[TVProgram] (
    ...
    [Cost]              NUMERIC (16)  NULL,
    CONSTRAINT [PK_TVProgram] PRIMARY KEY CLUSTERED ([TVProgramID] ASC),
    CONSTRAINT [FK_TVProgram_To_Language] FOREIGN KEY ([LanguageID]) REFERENCES [dbo].[Language] ([LanguageID]),
    CONSTRAINT [FK_TVProgram_To_TVProgramType] FOREIGN KEY ([TVProgramTypeCode]) REFERENCES [dbo].[TVProgramType] ([TVProgramTypeCode])
);


GO
CREATE TRIGGER [dbo].[TVProgram_AuditTrail] ON [dbo].[TVProgram] 
