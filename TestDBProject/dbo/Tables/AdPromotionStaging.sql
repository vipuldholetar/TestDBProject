CREATE TABLE [dbo].[AdPromotionStaging] (
    [CreativeCropStagingID] INT            NOT NULL,
    [RecordStagingID]       INT            NOT NULL,
...
GO
CREATE TRIGGER [dbo].[AdPromotionStaging_AuditTrail] ON [dbo].[AdPromotionStaging] 
...
SET @TableName = 'AdPromotionStaging'
...
END
GO
DISABLE TRIGGER [dbo].[AdPromotionStaging_AuditTrail]
    ON [dbo].[AdPromotionStaging];
