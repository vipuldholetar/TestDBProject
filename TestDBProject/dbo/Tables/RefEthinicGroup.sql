CREATE TABLE [dbo].[RefEthinicGroup] (
    [RefEthinicGroupID]  INT            IDENTITY (1, 1) NOT NULL,
...
GO
CREATE TRIGGER [dbo].[RefEthinicGroup_AuditTrail] ON [dbo].[RefEthinicGroup] 
