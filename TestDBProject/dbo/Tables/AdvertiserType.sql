CREATE TABLE [dbo].[AdvertiserType] (
    [AdvertiserTypeID] INT          NOT NULL,
    [AdvertiserType]   VARCHAR (50) NOT NULL,
    CONSTRAINT [FK_AdvertiserType_Advertiser] FOREIGN KEY ([AdvertiserTypeID]) REFERENCES [dbo].[AdvertiserOld] ([AdvertiserID])
);


GO
CREATE TRIGGER [dbo].[AdvertiserType_AuditTrail] ON [dbo].[AdvertiserType] 
