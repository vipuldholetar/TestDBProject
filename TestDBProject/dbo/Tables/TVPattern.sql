CREATE TABLE [dbo].[TVPattern] (
    [TVPatternCODE]  VARCHAR (200) NOT NULL,
    ...
    CONSTRAINT [PK_TVPatterns] PRIMARY KEY CLUSTERED ([TVPatternCODE] ASC)
);


GO
CREATE TRIGGER [dbo].[TVPattern_AuditTrail] ON [dbo].[TVPattern] 
