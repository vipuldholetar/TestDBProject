CREATE TABLE [dbo].[MapMODCondition] (
    [MapMODConditionID] INT           IDENTITY (1, 1) NOT NULL,
    [ConditionCODE]     NVARCHAR (50) NULL,
    [Type]              VARCHAR (50)  NULL,
    [EntityID]          INT           NULL,
    CONSTRAINT [PK_MapMODConditions] PRIMARY KEY CLUSTERED ([MapMODConditionID] ASC)
);


GO
CREATE TRIGGER [dbo].[MapMODCondition_AuditTrail] ON [dbo].[MapMODCondition] 
