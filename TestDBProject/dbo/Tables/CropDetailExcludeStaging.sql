CREATE TABLE [dbo].[CropDetailExcludeStaging] (
...
GO
CREATE TRIGGER [dbo].[CropDetailExcludeStaging_AuditTrail] ON [dbo].[CropDetailExcludeStaging] 
...
SET @TableName = 'CropDetailExcludeStaging'
