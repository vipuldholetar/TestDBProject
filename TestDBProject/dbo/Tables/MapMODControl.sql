CREATE TABLE [dbo].[MapMODControl] (
    [MadMODControlID]   INT            IDENTITY (1, 1) NOT NULL,
...
GO
CREATE TRIGGER [dbo].[MapMODControl_AuditTrail] ON [dbo].[MapMODControl] 
