CREATE TABLE [dbo].[QCStatus] (
    [QCStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]     VARCHAR (50)  NOT NULL,
    [Descrip]    VARCHAR (100) NULL,
    CONSTRAINT [PK_QCStatus] PRIMARY KEY CLUSTERED ([QCStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[QCStatus_AuditTrail] ON [dbo].[QCStatus] 
