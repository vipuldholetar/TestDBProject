CREATE TABLE [dbo].[AdTakeCount] (
    [AdTakeCountID] INT          IDENTITY (1, 1) NOT NULL,
    [AdvertiserID]  INT          NOT NULL,
    [MediaStream]   INT          NOT NULL,
    [LanguageID]    INT          NOT NULL,
    [MonthYear]     VARCHAR (50) NOT NULL,
    [MaxTakeCount]  INT          NULL,
    CONSTRAINT [PK_ADTAKECOUNT] PRIMARY KEY CLUSTERED ([AdTakeCountID] ASC)
);


GO
CREATE TRIGGER [dbo].[AdTakeCount_AuditTrail] ON [dbo].[AdTakeCount] 
