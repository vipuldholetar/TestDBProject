CREATE TABLE [dbo].[CreativeDetailMOB] (
    ...
    CONSTRAINT [PK_CreativeDetailMOB] PRIMARY KEY CLUSTERED ([CreativeDetailMOBID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idx_CreativeMasterID]
    ON [dbo].[CreativeDetailMOB]([CreativeMasterID] ASC);


GO
CREATE TRIGGER [dbo].[CreativeDetailMOB_AuditTrail] ON [dbo].[CreativeDetailMOB] 
...
SET @TableName = 'CreativeDetailMOB'
