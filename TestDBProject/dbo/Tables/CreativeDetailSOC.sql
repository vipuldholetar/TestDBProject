CREATE TABLE [dbo].[CreativeDetailSOC] (
    [CreativeDetailSOCID] INT           IDENTITY (1, 1) NOT NULL,
...
GO
CREATE TRIGGER [dbo].[CreativeDetailSOC_AuditTrail] ON [dbo].[CreativeDetailSOC] 
...
SET @TableName = 'CreativeDetailSOC'
