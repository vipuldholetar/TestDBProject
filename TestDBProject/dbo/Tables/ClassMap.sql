CREATE TABLE [dbo].[ClassMap] (
    [ClassMapID]   INT      IDENTITY (1, 1) NOT NULL,
    ...
    [ModifiedBy]   INT      NULL,
    [CTLegacyID]   INT      NULL,
    CONSTRAINT [PK_ClassMap_1] PRIMARY KEY CLUSTERED ([ClassMapID] ASC)
);


GO
CREATE TRIGGER [dbo].[ClassMap_AuditTrail] ON [dbo].[ClassMap] 
