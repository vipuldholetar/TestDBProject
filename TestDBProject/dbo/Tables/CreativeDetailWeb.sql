CREATE TABLE [dbo].[CreativeDetailWeb] (
    [CreativeDetailWebID] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailWeb] PRIMARY KEY CLUSTERED ([CreativeDetailWebID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailWeb_AuditTrail] ON [dbo].[CreativeDetailWeb] 
...
SET @TableName = 'CreativeDetailWeb'
