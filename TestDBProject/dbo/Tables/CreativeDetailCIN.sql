CREATE TABLE [dbo].[CreativeDetailCIN] (
    [CreativeDetailCINID]     INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailCIN] PRIMARY KEY CLUSTERED ([CreativeDetailCINID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailCIN_AuditTrail] ON [dbo].[CreativeDetailCIN] 
...
SET @TableName = 'CreativeDetailCIN'
