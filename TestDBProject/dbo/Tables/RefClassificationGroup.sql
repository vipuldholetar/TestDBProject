CREATE TABLE [dbo].[RefClassificationGroup] (
    [RefClassificationGroupID] INT          IDENTITY (1, 1) NOT NULL,
    [ClassificationGroupCODE]  VARCHAR (1)  NULL,
    [ClassificationGroupName]  VARCHAR (50) NOT NULL,
    [CreatedDT]                DATETIME     NOT NULL,
    [CreateByID]               INT          NOT NULL,
    [ModifiedDT]               DATETIME     NULL,
    [ModifiedByID]             INT          NULL,
    [CTLegacyMcerInitsCODE]    VARCHAR (3)  NULL,
    CONSTRAINT [PK_RefClassificationGroup] PRIMARY KEY CLUSTERED ([RefClassificationGroupID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefClassificationGroup_AuditTrail] ON [dbo].[RefClassificationGroup] 
...
SET @TableName = 'RefClassificationGroup'
