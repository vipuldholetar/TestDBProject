CREATE TABLE [dbo].[CommercialNetworkData] (
    [Value] NVARCHAR (MAX) NULL
);


GO
CREATE TRIGGER [dbo].[CommercialNetworkData_AuditTrail] ON [dbo].[CommercialNetworkData] 
...
SET @TableName = 'CommercialNetworkData'
