CREATE TABLE [dbo].[NLSNOvernightNetworkCableRating] (
    [NLSNOvernightNetworkCableRatingID] INT      IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_NLSNOvernightRating] PRIMARY KEY CLUSTERED ([NLSNOvernightNetworkCableRatingID] ASC),
    CONSTRAINT [FK_NLSNOvernightNetworkCableRating_To_TVStation] FOREIGN KEY ([TVStationID]) REFERENCES [dbo].[TVStation] ([TVStationID])
);
