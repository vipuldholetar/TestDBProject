CREATE TABLE [dbo].[IndexStatus] (
    [IndexStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]        VARCHAR (50)  NOT NULL,
    [Descrip]       VARCHAR (100) NULL,
    CONSTRAINT [PK_IndexStatus] PRIMARY KEY CLUSTERED ([IndexStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[IndexStatus_AuditTrail] ON [dbo].[IndexStatus] 
