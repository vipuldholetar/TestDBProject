CREATE TABLE [dbo].[AdvertiserOld] (
    [AdvertiserID] INT          IDENTITY (1, 1) NOT NULL,
    [Advertiser]   VARCHAR (50) NOT NULL,
    CONSTRAINT [PK_Advertiser] PRIMARY KEY CLUSTERED ([AdvertiserID] ASC)
);


GO
CREATE TRIGGER [dbo].[AdvertiserOld_AuditTrail] ON [dbo].[AdvertiserOld] 
