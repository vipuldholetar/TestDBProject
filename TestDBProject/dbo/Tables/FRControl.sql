CREATE TABLE [dbo].[FRControl] (
    [RetailerID]  INT NOT NULL,
    [MarketID]    INT NOT NULL,
    [FRControlID] INT NOT NULL,
    CONSTRAINT [PK_FRControl] PRIMARY KEY CLUSTERED ([RetailerID] ASC, [MarketID] ASC, [FRControlID] ASC),
    CONSTRAINT [FK_FRControl_FRStatus] FOREIGN KEY ([FRControlID]) REFERENCES [dbo].[FRStatus] ([FRStatusID]) ON DELETE CASCADE,
    CONSTRAINT [FK_FRControl_Ret] FOREIGN KEY ([RetailerID]) REFERENCES [dbo].[Advertiser] ([AdvertiserID]) ON DELETE CASCADE
);


GO
ALTER TABLE [dbo].[FRControl] NOCHECK CONSTRAINT [FK_FRControl_Ret];


GO
CREATE TRIGGER [dbo].[FRControl_AuditTrail] ON [dbo].[FRControl] 
