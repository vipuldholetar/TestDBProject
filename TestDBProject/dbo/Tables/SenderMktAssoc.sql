CREATE TABLE [dbo].[SenderMktAssoc] (
    [SenderID] INT NOT NULL,
    [MktID]    INT NOT NULL,
    CONSTRAINT [PK_SenderMktAssoc] PRIMARY KEY CLUSTERED ([SenderID] ASC, [MktID] ASC)
);


GO
CREATE TRIGGER [dbo].[SenderMktAssoc_AuditTrail] ON [dbo].[SenderMktAssoc] 
