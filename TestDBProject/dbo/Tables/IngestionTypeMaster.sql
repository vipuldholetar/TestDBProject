CREATE TABLE [dbo].[IngestionTypeMaster] (
    [IngestionTypeID] INT           IDENTITY (1, 1) NOT NULL,
    [Descrip]         VARCHAR (100) NOT NULL,
    [CreatedDT]       DATETIME      NOT NULL,
    [CreatedByID]     INT           NOT NULL,
    [ModifyDT]        DATETIME      NOT NULL,
    [ModifiedByID]    INT           NOT NULL,
    CONSTRAINT [PK_IngestionTypesMaster] PRIMARY KEY CLUSTERED ([IngestionTypeID] ASC)
);


GO
CREATE TRIGGER [dbo].[IngestionTypeMaster_AuditTrail] ON [dbo].[IngestionTypeMaster] 
...
SET @TableName = 'IngestionTypeMaster'
