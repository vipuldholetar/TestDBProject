CREATE TABLE [dbo].[RefIndustryGroup] (
    [RefIndustryGroupID]    INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK__RefIndus__F4A24B22D242776F] PRIMARY KEY CLUSTERED ([RefIndustryGroupID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefIndustryGroup_AuditTrail] ON [dbo].[RefIndustryGroup] 
...
SET @TableName = 'RefIndustryGroup'
