CREATE TABLE [dbo].[MTODRFormat] (
    [MTODRFormatID] INT            IDENTITY (1, 1) NOT NULL,
    [FormatDescrip] VARCHAR (1000) NOT NULL,
    [CreatedDT]     DATETIME       NOT NULL,
    [CreatedByID]   INT            NOT NULL,
    [ModifiedDT]    DATETIME       NULL,
    [ModifiedByID]  INT            NULL,
    CONSTRAINT [PK_MTODFormats] PRIMARY KEY CLUSTERED ([MTODRFormatID] ASC)
);


GO
CREATE TRIGGER [dbo].[MTODRFormat_AuditTrail] ON [dbo].[MTODRFormat] 
