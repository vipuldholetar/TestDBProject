CREATE TABLE [dbo].[TVProgramSchedule] (
    [TVProgramScheduleID] INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_TvProgramSchedule] PRIMARY KEY CLUSTERED ([TVProgramScheduleID] ASC)
);


GO
CREATE TRIGGER [dbo].[TVProgramSchedule_AuditTrail] ON [dbo].[TVProgramSchedule] 
...
SET @TableName = 'TVProgramSchedule'
