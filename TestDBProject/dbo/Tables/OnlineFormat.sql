CREATE TABLE [dbo].[OnlineFormat] (
    [OnlineFormatID]    INT            IDENTITY (1, 1) NOT NULL,
    [Name]              VARCHAR (60)   NOT NULL,
    [OnlineFormatCODE]  VARCHAR (10)   NOT NULL,
    [HorizontalSize]    NUMERIC (5)    NOT NULL,
    [VerticalSize]      NUMERIC (5)    NOT NULL,
    [CreatedDT]         DATETIME       CONSTRAINT [DF_OnlineFormats_CreateDTM] DEFAULT (getdate()) NOT NULL,
    [ModifiedDT]        DATETIME       NULL,
    [CpmCalcFormatCODE] VARCHAR (10)   NULL,
    [CostAdjustFactor]  NUMERIC (3, 2) NOT NULL
);


GO
CREATE TRIGGER [dbo].[OnlineFormat_AuditTrail] ON [dbo].[OnlineFormat] 
