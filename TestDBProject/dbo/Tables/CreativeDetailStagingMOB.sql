CREATE TABLE [dbo].[CreativeDetailStagingMOB] (
    ...
    [LandingPageDownloaded]   BIT            DEFAULT ((0)) NOT NULL,
    ...
    [CreatedDT]               DATETIME       CONSTRAINT [DF_CreativeDetailStagingMOB_CreateDTM] DEFAULT (getdate()) NOT NULL,
    [ModifiedDT]              DATETIME       NULL,
    [SourceUrlID]             INT            NOT NULL,
    [Height]                  INT            NULL,
    [Width]                   INT            NULL,
    [MediaFileName]           VARCHAR (500)  NULL,
    CONSTRAINT [PK_CreativeDetailStagingMOB] PRIMARY KEY CLUSTERED ([CreativeDetailStagingID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_CreativeDetailStagingMOB_SignatureDefault]
    ON [dbo].[CreativeDetailStagingMOB]([SignatureDefault] ASC);


GO
CREATE TRIGGER [dbo].[CreativeDetailStagingMOB_AuditTrail] ON dbo.CreativeDetailStagingMOB 
...
SET @TableName = 'CreativeDetailStagingMOB'
