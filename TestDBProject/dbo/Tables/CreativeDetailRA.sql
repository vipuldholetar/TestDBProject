CREATE TABLE [dbo].[CreativeDetailRA] (
    [CreativeDetailRAID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailsRA] PRIMARY KEY CLUSTERED ([CreativeDetailRAID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailRA_AuditTrail] ON [dbo].[CreativeDetailRA] 
...
SET @TableName = 'CreativeDetailRA'
