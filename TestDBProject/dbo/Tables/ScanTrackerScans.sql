CREATE TABLE [dbo].[ScanTrackerScans] (
    [ScanTrackerScansID] INT      IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [SessionID]          INT      NOT NULL,
    [OccurrenceID]       BIGINT   NOT NULL,
    [PageCount]          INT      NOT NULL,
    [PostDT]             DATETIME CONSTRAINT [DF_ScanTrackerScans_PostDate] DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [PK_ScanTrackerScans] PRIMARY KEY CLUSTERED ([ScanTrackerScansID] ASC)
);


GO
CREATE TRIGGER [dbo].[ScanTrackerScans_AuditTrail] ON [dbo].[ScanTrackerScans] 
...
SET @TableName = 'ScanTrackerScans'
