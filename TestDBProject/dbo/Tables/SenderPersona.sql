CREATE TABLE [dbo].[SenderPersona] (
    [SenderPersonaID]    INT           IDENTITY (1, 1) NOT NULL,
    ...
    [EndDT]              DATETIME      NULL,
    CONSTRAINT [PK_SenderPersona] PRIMARY KEY CLUSTERED ([SenderPersonaID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_SenderPersona_IDName]
    ON [dbo].[SenderPersona]([SenderPersonaID] ASC, [SenderName] ASC);


GO
CREATE TRIGGER [dbo].[SenderPersona_AuditTrail] ON [dbo].[SenderPersona] 
