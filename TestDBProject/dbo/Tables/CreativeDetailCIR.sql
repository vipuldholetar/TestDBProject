CREATE TABLE [dbo].[CreativeDetailCIR] (
    ...
    CONSTRAINT [PK_CREATIVEDETAILCIR] PRIMARY KEY CLUSTERED ([CreativeDetailID] ASC),
    CONSTRAINT [FK_CreativeDetailCIR_Size] FOREIGN KEY ([SizeID]) REFERENCES [dbo].[Size] ([SizeID])
);


GO
CREATE TRIGGER [dbo].[CreativeDetailCIR_AuditTrail] ON [dbo].[CreativeDetailCIR] 
...
SET @TableName = 'CreativeDetailCIR'
