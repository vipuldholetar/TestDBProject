CREATE TABLE [dbo].[OccurenceMediaType] (
    [OccurenceMediaTypeID] INT          IDENTITY (1, 1) NOT NULL,
    [MediaType]            VARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([OccurenceMediaTypeID] ASC)
);


GO
CREATE TRIGGER [dbo].[OccurenceMediaType_AuditTrail] ON [dbo].[OccurenceMediaType] 
...
SET @TableName = 'OccurenceMediaType'
