CREATE TABLE [dbo].[StatusMessage] (
    [StatusMessageID]  INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_STATUS_MESSAGE] PRIMARY KEY CLUSTERED ([StatusMessageID] ASC)
);


GO
CREATE TRIGGER [dbo].[StatusMessage_AuditTrail] ON [dbo].[StatusMessage] 
