CREATE TABLE [dbo].[RawTVPlaylistError] (
    [RawTVPlaylistError] BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    [CaptureTime]        TIME (7)      NOT NULL,
    [Length]             INT           NOT NULL,
    [CreatedDT]          DATETIME      NOT NULL,
    [IngestionDT]        DATETIME      NULL,
    [IngestionStatus]    INT           NULL,
    [Station]            VARCHAR (10)  NULL,
    CONSTRAINT [PK_RAWTVPlaylistError] PRIMARY KEY CLUSTERED ([RawTVPlaylistError] ASC)
);


GO
CREATE TRIGGER [dbo].[RawTVPlaylistError_AuditTrail] ON [dbo].[RawTVPlaylistError] 
...
SET @TableName = 'RawTVPlaylistError'
