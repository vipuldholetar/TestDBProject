CREATE TABLE [dbo].[RawTVNewAdError] (
    [RawTVNewAdErrorID] BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RAWTVNewPatternsError] PRIMARY KEY CLUSTERED ([RawTVNewAdErrorID] ASC)
);


GO
CREATE TRIGGER [dbo].[RawTVNewAdError_AuditTrail] ON [dbo].[RawTVNewAdError] 
