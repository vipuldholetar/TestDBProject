CREATE TABLE [dbo].[SenderExpectation] (
    [SenderID]      INT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_idxSenderExpectation_SenderIDExpectationID]
    ON [dbo].[SenderExpectation]([SenderID] ASC, [ExpectationID] ASC);


GO
CREATE TRIGGER [dbo].[SenderExpectation_AuditTrail] ON [dbo].[SenderExpectation] 
...
SET @TableName = 'SenderExpectation'
