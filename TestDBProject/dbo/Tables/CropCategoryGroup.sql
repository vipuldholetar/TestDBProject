CREATE TABLE [dbo].[CropCategoryGroup] (
    [CropCategoryGroupID] INT      NOT NULL,
...
GO
CREATE TRIGGER [dbo].[CropCategoryGroup_AuditTrail] ON [dbo].[CropCategoryGroup] 
...
SET @TableName = 'CropCategoryGroup'
