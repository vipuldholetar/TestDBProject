CREATE TABLE [dbo].[MediaOutletGenre] (
    [MediaOutletGenreID] INT           IDENTITY (55, 1) NOT NULL,
    [GenreName]          VARCHAR (100) NOT NULL,
    [CreatedDT]          DATETIME      CONSTRAINT [DF_MediaOutletGenre_CreateDTM] DEFAULT (getdate()) NOT NULL,
    [ModifiedDT]         DATETIME      NULL,
    [CTLegacySeq]        INT           NULL,
    CONSTRAINT [PK_MediaOutletGenre] PRIMARY KEY CLUSTERED ([MediaOutletGenreID] ASC)
);


GO
CREATE TRIGGER [dbo].[MediaOutletGenre_AuditTrail] ON [dbo].[MediaOutletGenre] 
...
SET @TableName = 'MediaOutletGenre'
