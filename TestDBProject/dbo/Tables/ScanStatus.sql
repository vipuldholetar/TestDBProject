CREATE TABLE [dbo].[ScanStatus] (
    [ScanStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]       VARCHAR (50)  NOT NULL,
    [Descrip]      VARCHAR (100) NULL,
    CONSTRAINT [PK_ScanStatus] PRIMARY KEY CLUSTERED ([ScanStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[ScanStatus_AuditTrail] ON [dbo].[ScanStatus] 
