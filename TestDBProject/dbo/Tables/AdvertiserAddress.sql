CREATE TABLE [dbo].[AdvertiserAddress] (
    [AdvertiserAddressID] INT          IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([AdvertiserAddressID] ASC),
    CONSTRAINT [FK_AdvertiserAddress_Advertiser] FOREIGN KEY ([AdvertiserID]) REFERENCES [dbo].[Advertiser] ([AdvertiserID])
);


GO
CREATE TRIGGER [dbo].[AdvertiserAddress_AuditTrail] ON [dbo].[AdvertiserAddress] 
...
SET @TableName = 'AdvertiserAddress'
