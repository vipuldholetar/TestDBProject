CREATE TABLE [dbo].[OccurrenceCostTV] (
    [OccurrenceCostTVID]        INT          IDENTITY (1, 1) NOT NULL,
    [OccurenceClientFacingTVID] INT          NOT NULL,
    ...
    CONSTRAINT [PK_OCCURRENCESCOSTTV] PRIMARY KEY CLUSTERED ([OccurrenceCostTVID] ASC),
    CONSTRAINT [FK_OCCURRENCESCOSTTV_OCCURRENCECLIENTFACINGTV] FOREIGN KEY ([OccurenceClientFacingTVID]) REFERENCES [dbo].[OccurrenceClientFacingTV] ([OccurrenceClientFacingTVId]),
    CONSTRAINT [FK_OCCURRENCESCOSTTV_TVDIODAYPARTS] FOREIGN KEY ([DayPartID]) REFERENCES [dbo].[RadioDayPart] ([RadioDayPartID])
);


GO
CREATE TRIGGER [dbo].[OccurrenceCostTV_AuditTrail] ON [dbo].[OccurrenceCostTV] 
...
SET @TableName = 'OccurrenceCostTV'
