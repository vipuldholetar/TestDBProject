CREATE TABLE [dbo].[UserMediaStream] (
    [MediaStream]  NVARCHAR (50) NOT NULL,
    [UserID]       INT           NOT NULL,
...
GO
CREATE TRIGGER [dbo].[UserMediaStream_AuditTrail] ON [dbo].[UserMediaStream] 
