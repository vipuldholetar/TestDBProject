CREATE TABLE [dbo].[QueryDetail] (
    ...
    [EntityLevel]           VARCHAR (MAX) NOT NULL,
    ...
    CONSTRAINT [PK_QueryDetails] PRIMARY KEY CLUSTERED ([QueryID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_QueryDetail_PatternStgID]
    ON [dbo].[QueryDetail]([PatternStgID] ASC);


GO
CREATE TRIGGER [dbo].[QueryDetail_AuditTrail] ON [dbo].[QueryDetail] 
