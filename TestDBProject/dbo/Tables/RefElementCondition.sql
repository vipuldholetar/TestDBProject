CREATE TABLE [dbo].[RefElementCondition] (
    [RefElementConditionID] INT            IDENTITY (1, 1) NOT NULL,
    [ConditionTitle]        VARCHAR (100)  NOT NULL,
    [AdLevelVariable]       VARCHAR (50)   NOT NULL,
    [ConditionOperator]     VARCHAR (50)   NOT NULL,
    [ConditionVariable]     VARCHAR (2000) NOT NULL,
    [ExpireDT]              DATETIME       NULL,
    [CTLegacyConditions]    VARCHAR (2000) NULL,
    [CTLegacyID]            INT            NULL,
    CONSTRAINT [PK_RefElementCondition] PRIMARY KEY CLUSTERED ([RefElementConditionID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefElementCondition_AuditTrail] ON [dbo].[RefElementCondition] 
...
SET @TableName = 'RefElementCondition'
