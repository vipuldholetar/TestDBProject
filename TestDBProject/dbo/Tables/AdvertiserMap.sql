CREATE TABLE [dbo].[AdvertiserMap] (
    [AdvertiserMapID] INT      IDENTITY (1, 1) NOT NULL,
    [RCSAdvertiserID] INT      NOT NULL,
    [AdvID]           INT      NULL,
    [Priority]        INT      NOT NULL,
    [AutoIndexing]    TINYINT  NOT NULL,
    ...
    [CTLegacyID]      INT      NULL,
    CONSTRAINT [PK_AdvMap] PRIMARY KEY CLUSTERED ([AdvertiserMapID] ASC)
);


GO
CREATE TRIGGER [dbo].[AdvertiserMap_AuditTrail] ON [dbo].[AdvertiserMap] 
