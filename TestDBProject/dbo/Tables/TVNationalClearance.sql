CREATE TABLE [dbo].[TVNationalClearance] (
    [TVNationalClearanceID] INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_TVCLEARANCE] PRIMARY KEY CLUSTERED ([TVNationalClearanceID] ASC)
);


GO
CREATE TRIGGER [dbo].[TVNationalClearance_AuditTrail] ON [dbo].[TVNationalClearance] 
...
SET @TableName = 'TVNationalClearance'
