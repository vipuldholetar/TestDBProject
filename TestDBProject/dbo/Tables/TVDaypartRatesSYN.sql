CREATE TABLE [dbo].[TVDaypartRatesSYN] (
    [TVDaypartRatesSYNId] INT          IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([TVDaypartRatesSYNId] ASC),
    CONSTRAINT [FK_TVDaypartRatesSYN_To_SQADProgramSubCat] FOREIGN KEY ([ProgramSubCatId]) REFERENCES [dbo].[TVSQADProgramSubCat] ([ProgramSubCatId])
);


GO
CREATE TRIGGER [dbo].[TVDaypartsRatesSYN_AuditTrail] ON [dbo].[TVDaypartRatesSYN] 
...
SET @TableName = 'TVDaypartsRatesSYN'
