CREATE TABLE [dbo].[RefElementCriteria] (
    [RefElementCriteriaID] INT           IDENTITY (1, 1) NOT NULL,
    [CriteriaTitle]        VARCHAR (100) NOT NULL,
    [KETemplateID]         INT           NOT NULL,
    [ExpireDT]             DATETIME      NULL,
    [CTLegacyID]           INT           NULL,
    CONSTRAINT [PK_RefElementCriteria] PRIMARY KEY CLUSTERED ([RefElementCriteriaID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefElementCriteria_AuditTrail] ON [dbo].[RefElementCriteria] 
...
SET @TableName = 'RefElementCriteria'
