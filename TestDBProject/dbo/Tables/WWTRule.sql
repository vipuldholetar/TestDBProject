CREATE TABLE [dbo].[WWTRule] (
    [WWTRuleID]     INT IDENTITY (1, 1) NOT NULL,
    [RuleTypeID]    INT NOT NULL,
    [WWTRuleNoteID] INT NULL,
    PRIMARY KEY CLUSTERED ([WWTRuleID] ASC),
    CONSTRAINT [FK_WWTRule_To_RuleType] FOREIGN KEY ([RuleTypeID]) REFERENCES [dbo].[RuleType] ([RuleTypeID]),
    CONSTRAINT [FK_WWTRule_To_WWTRuleNote] FOREIGN KEY ([WWTRuleNoteID]) REFERENCES [dbo].[WWTRuleNote] ([WWTRuleNoteID])
);


GO
CREATE TRIGGER [dbo].[WWTRule_AuditTrail] ON [dbo].[WWTRule] 
