CREATE TABLE [dbo].[Scheduler] (
    ...
    [ProcessGroup]        VARCHAR (200)  NOT NULL,
    [ProcessID]           VARCHAR (200)  NOT NULL,
    [Type]                VARCHAR (200)  NOT NULL,
    [CurrentScheduleType] VARCHAR (200)  NOT NULL,
    [ProcessName]         VARCHAR (200)  NOT NULL,
    [StartDT]             DATETIME       NOT NULL,
    [EndDT]               DATETIME       NULL,
    [OccurrenceTime]      VARCHAR (200)  NOT NULL,
    [DayOfTheWeek]        VARCHAR (1000) NOT NULL,
...
GO
CREATE TRIGGER [dbo].[Scheduler_AuditTrail] ON [dbo].[Scheduler] 
