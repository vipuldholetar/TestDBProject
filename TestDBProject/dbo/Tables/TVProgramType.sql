CREATE TABLE [dbo].[TVProgramType] (
    [TVProgramTypeCode] VARCHAR (1)  NOT NULL,
    [TVProgramTypeName] VARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([TVProgramTypeCode] ASC)
);


GO
CREATE TRIGGER [dbo].[TVProgramType_AuditTrail] ON [dbo].[TVProgramType] 
