CREATE TABLE [dbo].[MediaStreamGroup] (
    [MediaStreamGroupID] INT          IDENTITY (1, 1) NOT NULL,
    [MediaStreamGroup]   VARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([MediaStreamGroupID] ASC)
);


GO
CREATE TRIGGER [dbo].[MediaStreamGroup_AuditTrail] ON [dbo].[MediaStreamGroup] 
...
SET @TableName = 'MediaStreamGroup'
