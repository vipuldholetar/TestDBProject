CREATE TABLE [dbo].[TVNetwork] (
    [TVNetworkID]      INT          IDENTITY (1, 1) NOT NULL,
    [NetworkShortName] VARCHAR (50) NOT NULL,
    [CreatedDT]        DATETIME     NOT NULL,
    [CreatedByID]      INT          NOT NULL,
    [ModifiedDT]       DATETIME     NULL,
    [ModifiedByID]     INT          NULL,
    CONSTRAINT [PK_TVNetwork] PRIMARY KEY CLUSTERED ([TVNetworkID] ASC)
);


GO
CREATE TRIGGER [dbo].[TVNetwork_AuditTrail] ON [dbo].[TVNetwork] 
