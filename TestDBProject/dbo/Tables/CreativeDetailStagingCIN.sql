CREATE TABLE [dbo].[CreativeDetailStagingCIN] (
    [CreativeDetailStagingCINID] INT           IDENTITY (1, 1) NOT NULL,
    [CreativeStagingID]          INT           NOT NULL,
    [CreativeFileType]           CHAR (10)     NOT NULL,
    [CreativeRepository]         VARCHAR (200) NOT NULL,
    [CreativeAssetName]          VARCHAR (200) NOT NULL,
    [CreativeFileSize]           BIGINT        NOT NULL,
    CONSTRAINT [PK_CreativeDetailCINStaging] PRIMARY KEY CLUSTERED ([CreativeDetailStagingCINID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailStagingCIN_AuditTrail] ON [dbo].[CreativeDetailStagingCIN] 
...
SET @TableName = 'CreativeDetailStagingCIN'
