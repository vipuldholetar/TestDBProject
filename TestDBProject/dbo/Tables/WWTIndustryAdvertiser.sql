CREATE TABLE [dbo].[WWTIndustryAdvertiser] (
    [WWTIndustryID] INT NOT NULL,
    [AdvertiserID]  INT NOT NULL,
    CONSTRAINT [PK_WWTIndustryAdvertiser] PRIMARY KEY CLUSTERED ([WWTIndustryID] ASC, [AdvertiserID] ASC),
    CONSTRAINT [FK_WWTIndustryAdvertiser_To_Advertiser] FOREIGN KEY ([AdvertiserID]) REFERENCES [dbo].[Advertiser] ([AdvertiserID]),
    CONSTRAINT [FK_WWTIndustryAdvertiser_To_WWTIndustry] FOREIGN KEY ([WWTIndustryID]) REFERENCES [dbo].[WWTIndustry] ([WWTIndustryID])
);


GO
CREATE NONCLUSTERED INDEX [IX_WWTIndustryAdvertiser_AdvertiserIndustry]
    ON [dbo].[WWTIndustryAdvertiser]([AdvertiserID] ASC, [WWTIndustryID] ASC);


GO
CREATE TRIGGER [dbo].[WWTIndustryAdvertiser_AuditTrail] ON [dbo].[WWTIndustryAdvertiser] 
...
SET @TableName = 'WWTIndustryAdvertiser'
