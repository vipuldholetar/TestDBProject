CREATE TABLE [dbo].[RefSubCategory] (
    [RefSubCategoryID]     INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RefSubCategory] PRIMARY KEY CLUSTERED ([RefSubCategoryID] ASC),
    CONSTRAINT [FK_RefSubCategory_RefCategory] FOREIGN KEY ([CategoryID]) REFERENCES [dbo].[RefCategory] ([RefCategoryID])
);


GO
CREATE TRIGGER [dbo].[RefSubCategory_AuditTrail] ON [dbo].[RefSubCategory] 
