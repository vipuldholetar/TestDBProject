CREATE TABLE [dbo].[StationMapMaster] (
    [StationMapMasterID] INT      IDENTITY (284, 1) NOT NULL,
    [TMSStationID]       INT      NOT NULL,
    [TVStationID]        INT      NOT NULL,
    [CreatedDT]          DATETIME DEFAULT (getdate()) NULL,
    [CreatedByID]        INT      NULL,
    [ModifiedDT]         DATETIME NULL,
    [ModifiedByID]       INT      NULL,
    CONSTRAINT [PK_StationMapMaster] PRIMARY KEY CLUSTERED ([StationMapMasterID] ASC)
);


GO
CREATE TRIGGER [dbo].[StationMapMaster_AuditTrail] ON [dbo].[StationMapMaster] 
...
SET @TableName = 'StationMapMaster'
