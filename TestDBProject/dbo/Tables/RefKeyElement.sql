CREATE TABLE [dbo].[RefKeyElement] (
    [RefKeyElementID]  INT           IDENTITY (1, 1) NOT NULL,
    [KeyElementName]   VARCHAR (50)  NOT NULL,
    [KElementDataType] VARCHAR (255) NOT NULL,
    [MaskFormat]       VARCHAR (50)  NULL,
    [MultiInd]         TINYINT       NOT NULL,
...
GO
CREATE TRIGGER [dbo].[RefKeyElement_AuditTrail] ON [dbo].[RefKeyElement] 
