CREATE TABLE [dbo].[OccurrenceDetailSOC] (
    [OccurrenceDetailSOCID] BIGINT        IDENTITY (1, 1) NOT NULL,
    [MediaTypeID]           INT           NOT NULL,
    [MarketID]              INT           NULL,
    [EnvelopeID]            INT           NULL,
    [AdID]                  INT           NULL,
    [PatternID]             INT           NULL,
    [SocialType]            VARCHAR (MAX) NOT NULL,
    ...
    [WebsiteID]             INT           NULL,
    CONSTRAINT [FK_OccurrenceDetailSOC_IndexStatus] FOREIGN KEY ([IndexStatusID]) REFERENCES [dbo].[IndexStatus] ([IndexStatusID]),
    CONSTRAINT [FK_OccurrenceDetailSOC_MapStatus] FOREIGN KEY ([MapStatusID]) REFERENCES [dbo].[MapStatus] ([MapStatusID]),
    CONSTRAINT [FK_OccurrenceDetailSOC_OccurrenceStatus] FOREIGN KEY ([OccurrenceStatusID]) REFERENCES [dbo].[OccurrenceStatus] ([OccurrenceStatusID]),
    CONSTRAINT [FK_OccurrenceDetailSOC_QCStatus] FOREIGN KEY ([QCStatusID]) REFERENCES [dbo].[QCStatus] ([QCStatusID]),
    CONSTRAINT [FK_OccurrenceDetailSOC_RouteStatus] FOREIGN KEY ([RouteStatusID]) REFERENCES [dbo].[RouteStatus] ([RouteStatusID]),
    CONSTRAINT [FK_OccurrenceDetailSOC_ScanStatus] FOREIGN KEY ([ScanStatusID]) REFERENCES [dbo].[ScanStatus] ([ScanStatusID])
);


GO
CREATE TRIGGER [dbo].[OccurrenceDetailSOC_AuditTrail] ON [dbo].[OccurrenceDetailSOC] 
...
SET @TableName = 'OccurrenceDetailSOC'
