CREATE TABLE [dbo].[RawTVPlaylist] (
    [RawTVPlaylistID]    BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RAWTVPlaylist] PRIMARY KEY CLUSTERED ([RawTVPlaylistID] ASC)
);


GO
CREATE TRIGGER [dbo].[RawTVPlaylist_AuditTrail] ON [dbo].[RawTVPlaylist] 
