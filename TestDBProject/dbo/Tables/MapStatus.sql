CREATE TABLE [dbo].[MapStatus] (
    [MapStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]      VARCHAR (50)  NOT NULL,
    [Descrip]     VARCHAR (100) NULL,
    CONSTRAINT [PK_MapStatus] PRIMARY KEY CLUSTERED ([MapStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[MapStatus_AuditTrail] ON [dbo].[MapStatus] 
