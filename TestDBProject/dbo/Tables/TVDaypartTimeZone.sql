CREATE TABLE [dbo].[TVDaypartTimeZone] (
    [TVDaypartTimeZoneID] INT          IDENTITY (1, 1) NOT NULL,
    [Code]                VARCHAR (2)  NOT NULL,
    [Name]                VARCHAR (50) NOT NULL,
    [TimeZone]            VARCHAR (3)  NOT NULL,
    [DaysOfTheWeek]       VARCHAR (7)  NOT NULL,
    [StartTime]           TIME (7)     NOT NULL,
    [EndTime]             TIME (7)     NOT NULL,
    PRIMARY KEY CLUSTERED ([TVDaypartTimeZoneID] ASC)
);


GO
CREATE TRIGGER [dbo].[TVDaypartTimeZone_AuditTrail] ON [dbo].[TVDaypartTimeZone] 
...
SET @TableName = 'TVDaypartTimeZone'
