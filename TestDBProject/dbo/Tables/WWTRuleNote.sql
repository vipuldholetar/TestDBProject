CREATE TABLE [dbo].[WWTRuleNote] (
    [WWTRuleNoteID] INT           IDENTITY (1, 1) NOT NULL,
    [RuleNote]      VARCHAR (100) NULL,
    PRIMARY KEY CLUSTERED ([WWTRuleNoteID] ASC)
);


GO
CREATE TRIGGER [dbo].[WWTRuleNote_AuditTrail] ON [dbo].[WWTRuleNote] 
