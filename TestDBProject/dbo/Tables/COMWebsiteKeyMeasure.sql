CREATE TABLE [dbo].[COMWebsiteKeyMeasure] (
    [COMWebsiteKeyMeasureID] INT              IDENTITY (1, 1) NOT NULL,
    [SiteID]                 INT              NOT NULL,
    [UniqueVisitors]         DECIMAL (38, 12) NOT NULL,
    [MinutesVisited]         DECIMAL (38, 12) NOT NULL,
    [PagesViewed]            DECIMAL (38, 12) NOT NULL,
    [TotalVisits]            DECIMAL (38, 12) NOT NULL,
    [TimePeriodID]           INT              NOT NULL,
    [IngestionDT]            DATE             NOT NULL,
    CONSTRAINT [PK_COMWebsiteKeyMeasures] PRIMARY KEY CLUSTERED ([COMWebsiteKeyMeasureID] ASC),
    CONSTRAINT [FK_COMWebsiteKeyMeasures_COMTimePeriodsMaster] FOREIGN KEY ([TimePeriodID]) REFERENCES [dbo].[COMTimePeriod] ([COMTimePeriodID]),
    CONSTRAINT [FK_COMWebsiteKeyMeasures_COMWebSitesMaster] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[COMWebsite] ([COMWebsiteID])
);


GO
CREATE TRIGGER [dbo].[COMWebsiteKeyMeasure_AuditTrail] ON [dbo].[COMWebsiteKeyMeasure] 
...
SET @TableName = 'COMWebsiteKeyMeasure'
