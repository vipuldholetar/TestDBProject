CREATE TABLE [dbo].[MediaStreamAssociation] (
    [MediaStreamAssocID] INT IDENTITY (1, 1) NOT NULL,
    [MediaStreamID]      INT NOT NULL,
    [MediaStreamGroupID] INT NOT NULL,
    PRIMARY KEY CLUSTERED ([MediaStreamAssocID] ASC),
    CONSTRAINT [FK_MediaStreamAssociation_To_MediaStreamGroup] FOREIGN KEY ([MediaStreamGroupID]) REFERENCES [dbo].[MediaStreamGroup] ([MediaStreamGroupID])
);


GO
CREATE TRIGGER [dbo].[MediaStreamAssociation_AuditTrail] ON [dbo].[MediaStreamAssociation] 
...
SET @TableName = 'MediaStreamAssociation'
