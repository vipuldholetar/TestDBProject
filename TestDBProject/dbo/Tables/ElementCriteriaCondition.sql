CREATE TABLE [dbo].[ElementCriteriaCondition] (
    [CriteriaConditionID] INT           IDENTITY (1, 1) NOT NULL,
...
GO
CREATE TRIGGER [dbo].[ElementCriteriaCondition_AuditTrail] ON [dbo].[ElementCriteriaCondition] 
...
SET @TableName = 'ElementCriteriaCondition'
