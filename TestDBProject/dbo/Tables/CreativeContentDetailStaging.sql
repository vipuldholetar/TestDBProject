CREATE TABLE [dbo].[CreativeContentDetailStaging] (
    [CreativeContentDetailStagingID] INT      IDENTITY (1, 1) NOT NULL,
    [CreativeCropStagingID]          INT      NOT NULL,
    ...
    CONSTRAINT [PK_CreativeContentDetailStaging] PRIMARY KEY CLUSTERED ([CreativeContentDetailStagingID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeContentDetailStaging_AuditTrail] ON [dbo].[CreativeContentDetailStaging] 
...
SET @TableName = 'CreativeContentDetailStaging'
