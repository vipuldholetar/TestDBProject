CREATE TABLE [dbo].[ODRAdFormatMap] (
    [MTFormatID]      INT           IDENTITY (1, 1) NOT NULL,
    [GroupID]         INT           NOT NULL,
    [FamilyID]        INT           NOT NULL,
    [CMSSourceFormat] VARCHAR (200) NOT NULL,
    [FormatDescrip]   VARCHAR (200) NOT NULL,
    [CreatedDT]       DATETIME      DEFAULT (getdate()) NOT NULL,
    [CreatedByID]     INT           NOT NULL,
    [ModifiedDT]      DATETIME      NULL,
    [ModifiedByID]    INT           NULL,
    CONSTRAINT [PK_AdFormatMapODR] PRIMARY KEY CLUSTERED ([MTFormatID] ASC)
);


GO
CREATE TRIGGER [dbo].[ODRAdFormatMap_AuditTrail] ON [dbo].[ODRAdFormatMap] 
