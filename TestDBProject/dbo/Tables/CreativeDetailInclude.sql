CREATE TABLE [dbo].[CreativeDetailInclude] (
    [FK_CropID]          INT      NOT NULL,
...
GO
CREATE TRIGGER [dbo].[CreativeDetailInclude_AuditTrail] ON [dbo].[CreativeDetailInclude] 
...
SET @TableName = 'CreativeDetailInclude'
