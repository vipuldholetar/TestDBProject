CREATE TABLE [dbo].[CreativeDetailStagingOND] (
    ...
    [CreativeDownloaded]      BIT            DEFAULT ((0)) NOT NULL,
    ...
    [CreatedDT]               DATETIME       CONSTRAINT [DF_CreativeDetailStagingOND_CreateDTM] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailStagingOND] PRIMARY KEY CLUSTERED ([CreativeDetailStagingID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDX_CreativeFileType]
    ON [dbo].[CreativeDetailStagingOND]([CreativeFileType] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CreativeDetailStagingOND_CreativeFileTypeCreativeDownloadedFileSize]
    ON [dbo].[CreativeDetailStagingOND]([CreativeFileType] ASC, [CreativeDownloaded] ASC, [FileSize] ASC)
    INCLUDE([CreativeStagingID]);


GO
CREATE TRIGGER [dbo].[CreativeDetailStagingOND_AuditTrail] ON [dbo].[CreativeDetailStagingOND] 
...
SET @TableName = 'CreativeDetailStagingOND'
