CREATE TABLE [dbo].[ScreenRoles] (
    [ScreenID] INT NOT NULL,
    [RoleID]   INT NOT NULL,
    CONSTRAINT [PK_ScreenRole] PRIMARY KEY CLUSTERED ([ScreenID] ASC, [RoleID] ASC),
    CONSTRAINT [FK_ScreenRoles_Role] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[Role] ([RoleID]),
    CONSTRAINT [FK_ScreenRoles_Screen] FOREIGN KEY ([ScreenID]) REFERENCES [dbo].[Screen] ([ScreenID])
);


GO
CREATE TRIGGER [dbo].[ScreenRoles_AuditTrail] ON [dbo].[ScreenRoles] 
