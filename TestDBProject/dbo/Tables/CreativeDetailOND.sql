CREATE TABLE [dbo].[CreativeDetailOND] (
    [CreativeDetailONDID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailOND] PRIMARY KEY CLUSTERED ([CreativeDetailONDID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailOND_AuditTrail] ON [dbo].[CreativeDetailOND] 
...
SET @TableName = 'CreativeDetailOND'
