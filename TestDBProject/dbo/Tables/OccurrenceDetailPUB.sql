CREATE TABLE [dbo].[OccurrenceDetailPUB] (
    [OccurrenceDetailPUBID]    BIGINT        IDENTITY (1, 1) NOT NULL,
    [AdID]                     INT           NULL,
    ...
    CONSTRAINT [PK_OccurrenceDetailsPUB] PRIMARY KEY CLUSTERED ([OccurrenceDetailPUBID] ASC),
    CONSTRAINT [FK_OccurrenceDetailsPUB_ClearanceStatus] FOREIGN KEY ([ClearanceStatusID]) REFERENCES [dbo].[ClearanceStatus] ([ClearanceStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_IndexStatus] FOREIGN KEY ([IndexStatusID]) REFERENCES [dbo].[IndexStatus] ([IndexStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_MapStatus] FOREIGN KEY ([MapStatusID]) REFERENCES [dbo].[MapStatus] ([MapStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_MediaType] FOREIGN KEY ([MediaTypeID]) REFERENCES [dbo].[MediaType] ([MediaTypeID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_OccurrenceStatus] FOREIGN KEY ([OccurrenceStatusID]) REFERENCES [dbo].[OccurrenceStatus] ([OccurrenceStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_PubIssue] FOREIGN KEY ([PubIssueID]) REFERENCES [dbo].[PubIssue] ([PubIssueID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_QCStatus] FOREIGN KEY ([QCStatusID]) REFERENCES [dbo].[QCStatus] ([QCStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_RouteStatus] FOREIGN KEY ([RouteStatusID]) REFERENCES [dbo].[RouteStatus] ([RouteStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_ScanStatus] FOREIGN KEY ([ScanStatusID]) REFERENCES [dbo].[ScanStatus] ([ScanStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsPUB_SubSource] FOREIGN KEY ([SubSourceID]) REFERENCES [dbo].[SubSource] ([SubSourceID])
);


GO
CREATE TRIGGER [dbo].[OccurrenceDetailPUB_AuditTrail] ON [dbo].[OccurrenceDetailPUB] 
...
SET @TableName = 'OccurrenceDetailPUB'
