CREATE TABLE [dbo].[COMWebsiteExtSrcMap] (
    [COMWebsiteExtSrcMapID] INT           NOT NULL,
    [SiteID]                INT           NOT NULL,
    [ExtSrcName]            VARCHAR (MAX) NOT NULL,
    [ExtSrcID]              INT           NOT NULL,
    [ExtSrcStartDT]         DATE          NOT NULL,
    [ExtSrcEndDT]           DATE          NOT NULL,
    [Comments]              VARCHAR (MAX) NOT NULL,
    [CreatedDT]             DATE          NOT NULL,
    [CreatedByID]           INT           NOT NULL,
    [ModifiedDT]            DATE          NOT NULL,
    [ModifiedByID]          INT           NOT NULL,
    CONSTRAINT [PK_COMWebsiteExtSrcMapMaster] PRIMARY KEY CLUSTERED ([COMWebsiteExtSrcMapID] ASC)
);


GO
CREATE TRIGGER [dbo].[COMWebsiteExtSrcMap_AuditTrail] ON [dbo].[COMWebsiteExtSrcMap] 
...
SET @TableName = 'COMWebsiteExtSrcMap'
