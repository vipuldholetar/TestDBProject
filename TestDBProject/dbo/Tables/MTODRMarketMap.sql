CREATE TABLE [dbo].[MTODRMarketMap] (
    [MTODRMarketMapID] INT           IDENTITY (1, 1) NOT NULL,
    [MarketID]         INT           NULL,
    [CMSMarketCODE]    VARCHAR (200) NOT NULL,
    [CMSMarketName]    VARCHAR (200) NOT NULL,
    ...
    CONSTRAINT [PK_MTODRMarketMap] PRIMARY KEY CLUSTERED ([MTODRMarketMapID] ASC)
);


GO
CREATE TRIGGER [dbo].[MTODRMarketMap_AuditTrail] ON [dbo].[MTODRMarketMap] 
