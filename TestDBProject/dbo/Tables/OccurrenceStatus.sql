CREATE TABLE [dbo].[OccurrenceStatus] (
    [OccurrenceStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]             VARCHAR (50)  NOT NULL,
    [Descrip]            VARCHAR (100) NULL,
    CONSTRAINT [PK_OccurrenceStatus] PRIMARY KEY CLUSTERED ([OccurrenceStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[OccurrenceStatus_AuditTrail] ON [dbo].[OccurrenceStatus] 
...
SET @TableName = 'OccurrenceStatus'
