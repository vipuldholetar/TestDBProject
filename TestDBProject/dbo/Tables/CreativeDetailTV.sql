CREATE TABLE [dbo].[CreativeDetailTV] (
    [CreativeDetailTVID]      INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailTV] PRIMARY KEY CLUSTERED ([CreativeDetailTVID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailTV_AuditTrail] ON [dbo].[CreativeDetailTV] 
...
SET @TableName = 'CreativeDetailTV'
