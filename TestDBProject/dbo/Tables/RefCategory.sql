CREATE TABLE [dbo].[RefCategory] (
    [RefCategoryID]     INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RefCategory] PRIMARY KEY CLUSTERED ([RefCategoryID] ASC),
    CONSTRAINT [FK_RefCategory_RefCategoryGroup] FOREIGN KEY ([CategoryGroupID]) REFERENCES [dbo].[RefCategoryGroup] ([RefCategoryGroupID])
);


GO
CREATE TRIGGER [dbo].[RefCategory_AuditTrail] ON [dbo].[RefCategory] 
