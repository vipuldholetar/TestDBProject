CREATE TABLE [dbo].[MobileDevice] (
    [MobileDeviceID]  INT          IDENTITY (71, 1) NOT NULL,
    [Category]        VARCHAR (24) NOT NULL,
    [Name]            VARCHAR (48) NOT NULL,
    [Manufacturer]    VARCHAR (24) NOT NULL,
    [Model]           VARCHAR (24) NOT NULL,
    [OperatingSystem] VARCHAR (24) NOT NULL,
    [Active]          TINYINT      NULL,
    [CreatedDT]       DATETIME     NOT NULL,
    [ModifiedDT]      DATETIME     NULL,
    [CTLegacySeq]     INT          NULL,
    CONSTRAINT [PK_MobileDevice] PRIMARY KEY CLUSTERED ([MobileDeviceID] ASC)
);


GO
CREATE TRIGGER [dbo].[MobileDevice_AuditTrail] ON [dbo].[MobileDevice] 
