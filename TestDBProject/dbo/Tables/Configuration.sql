CREATE TABLE [dbo].[Configuration] (
    ...
    CONSTRAINT [PK_CONFIGURATIONMASTER] PRIMARY KEY CLUSTERED ([ConfigurationID] ASC)
);


GO
CREATE TRIGGER [dbo].[Configuration_AuditTrail] ON [dbo].[Configuration] 
