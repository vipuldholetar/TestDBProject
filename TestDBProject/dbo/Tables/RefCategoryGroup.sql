CREATE TABLE [dbo].[RefCategoryGroup] (
    [RefCategoryGroupID]    INT          IDENTITY (1, 1) NOT NULL,
    [ClassificationGroupID] INT          NOT NULL,
    [CategoryGroupName]     VARCHAR (50) NOT NULL,
    [CreateDT]              DATETIME     NOT NULL,
    [CreatedByID]           INT          NOT NULL,
    [ModifiedDT]            DATETIME     NULL,
    [ModifiedByID]          INT          NULL,
    CONSTRAINT [PK_RefCategoryGroup] PRIMARY KEY CLUSTERED ([RefCategoryGroupID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefCategoryGroup_AuditTrail] ON [dbo].[RefCategoryGroup] 
...
SET @TableName = 'RefCategoryGroup'
