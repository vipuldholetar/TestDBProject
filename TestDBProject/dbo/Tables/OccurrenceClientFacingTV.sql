CREATE TABLE [dbo].[OccurrenceClientFacingTV] (
    [OccurrenceClientFacingTVId] INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_OCCURRENCECLIENTFACINGTV] PRIMARY KEY CLUSTERED ([OccurrenceClientFacingTVId] ASC),
    CONSTRAINT [FK_OCCURRENCECLIENTFACINGTV_OCCURRENCECLEATVNCETV] FOREIGN KEY ([OccurrenceClearanceTVId]) REFERENCES [dbo].[OccurrenceClearanceTV] ([OccurrenceClearanceTVID])
);


GO
CREATE TRIGGER [dbo].[OccurrenceClientFacingTV_AuditTrail] ON [dbo].[OccurrenceClientFacingTV] 
...
SET @TableName = 'OccurrenceClientFacingTV'
