CREATE TABLE [dbo].[OccurrenceDetailODR] (
    [OccurrenceDetailODRID] BIGINT        IDENTITY (1, 1) NOT NULL,
    [PatternID]             INT           NULL,
    [AdID]                  INT           NULL,
    ...
    [Priority]              INT           NULL,
    [SourceFTPFolder]       VARCHAR (200) NOT NULL,
    [CMSImageDT]            DATETIME      NULL,
    [CMSImageSize]          INT           NOT NULL,
    ...
    [FileSource]            VARCHAR (200) NOT NULL,
    [FileSourceType]        VARCHAR (200) NULL,
    [WorkType]              INT           NOT NULL,
    [CreatedDT]             DATETIME      DEFAULT (getdate()) NOT NULL,
    [ModifiedDT]            DATETIME      NULL,
    CONSTRAINT [PK_OccurrenceDetailsODR] PRIMARY KEY CLUSTERED ([OccurrenceDetailODRID] ASC),
    CONSTRAINT [FK_OccurrenceDetailsODR_ODRAdFormatMap] FOREIGN KEY ([AdFormatID]) REFERENCES [dbo].[ODRAdFormatMap] ([MTFormatID])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_OccurrenceDetailODR_ImageFileName]
    ON [dbo].[OccurrenceDetailODR]([ImageFileName] ASC);


GO
CREATE NONCLUSTERED INDEX [IXOccurrenceDetailODR_AdIDMTMarketID]
    ON [dbo].[OccurrenceDetailODR]([AdID] ASC, [MTMarketID] ASC);


GO
CREATE TRIGGER [dbo].[OccurrenceDetailODR_AuditTrail] ON [dbo].[OccurrenceDetailODR] 
...
SET @TableName = 'OccurrenceDetailODR'
