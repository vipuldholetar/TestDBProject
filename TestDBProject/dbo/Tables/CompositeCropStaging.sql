CREATE TABLE [dbo].[CompositeCropStaging] (
    [CompositeCropStagingID] INT     IDENTITY (1, 1) NOT NULL,
    [CreativeCropStagingID]  INT     NULL,
    [CropID]                 INT     NULL,
    [Deleted]                TINYINT NULL,
    CONSTRAINT [PK_CompositeCropStaging] PRIMARY KEY CLUSTERED ([CompositeCropStagingID] ASC)
);


GO
CREATE TRIGGER [dbo].[CompositeCropStaging_AuditTrail] ON [dbo].[CompositeCropStaging] 
...
SET @TableName = 'CompositeCropStaging'
