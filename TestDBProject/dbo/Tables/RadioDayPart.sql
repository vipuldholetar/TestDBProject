CREATE TABLE [dbo].[RadioDayPart] (
    [RadioDayPartID] INT           IDENTITY (1, 1) NOT NULL,
    [Day]            VARCHAR (100) NOT NULL,
    [DayPart]        VARCHAR (100) NOT NULL,
    ...
    CONSTRAINT [PK_RADIODAYPARTS] PRIMARY KEY CLUSTERED ([RadioDayPartID] ASC)
);


GO
CREATE TRIGGER [dbo].[RadioDayPart_AuditTrail] ON [dbo].[RadioDayPart] 
