CREATE TABLE [dbo].[CreativeForCrop] (
    [CreativeForCropID] INT            IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeforCrop] PRIMARY KEY CLUSTERED ([CreativeForCropID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeForCrop_AuditTrail] ON [dbo].[CreativeForCrop] 
