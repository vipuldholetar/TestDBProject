CREATE TABLE [dbo].[ConfigurationReqdStage] (
    [MTCTBoth]     VARCHAR (2) NOT NULL,
    [NewAdInd]     BIT         NOT NULL,
    [MapReqdInd]   BIT         CONSTRAINT [DF_ConfigReqdStages1_MapReqdIndicator] DEFAULT ((0)) NULL,
    [IndexReqdInd] BIT         CONSTRAINT [DF_ConfigReqdStages1_IndexReqdIndicator] DEFAULT ((0)) NULL,
    [ScanReqdInd]  BIT         CONSTRAINT [DF_ConfigReqdStages1_ScanReqdIndicator] DEFAULT ((0)) NULL,
    [QCReqdInd]    BIT         CONSTRAINT [DF_ConfigReqdStages1_QCReqdIndicator] DEFAULT ((0)) NULL,
    [RouteReqdInd] BIT         CONSTRAINT [DF_ConfigReqdStages1_RouteReqdIndicator] DEFAULT ((0)) NULL,
    [CreatedDT]    DATETIME    NOT NULL,
    [CreateByID]   INT         NOT NULL,
    [ModifiedDT]   DATETIME    NULL,
    [ModifiedByID] INT         NULL,
    CONSTRAINT [PK_ConfigReqdStages] PRIMARY KEY CLUSTERED ([MTCTBoth] ASC, [NewAdInd] ASC)
);


GO
CREATE TRIGGER [dbo].[ConfigurationReqdStage_AuditTrail] ON [dbo].[ConfigurationReqdStage] 
...
SET @TableName = 'ConfigurationReqdStage'
