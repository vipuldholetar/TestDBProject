CREATE TABLE [dbo].[CINPattern] (
    [CINPatternID] BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CINPatterns] PRIMARY KEY CLUSTERED ([CINPatternID] ASC)
);


GO
CREATE TRIGGER [dbo].[CINPattern_AuditTrail] ON [dbo].[CINPattern] 
