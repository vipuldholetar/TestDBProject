CREATE TABLE [dbo].[MTPRTVStationMap] (
    [PRStationCODE]    VARCHAR (200) NOT NULL,
    [MTStationID]      INT           NOT NULL,
    [EthnicID]         INT           NULL,
...
GO
CREATE TRIGGER [dbo].[MTPRTVStationMap_AuditTrail] ON [dbo].[MTPRTVStationMap] 
...
SET @TableName = 'MTPRTVStationMap'
