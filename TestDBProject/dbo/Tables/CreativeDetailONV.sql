CREATE TABLE [dbo].[CreativeDetailONV] (
    [CreativeDetailONVID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CreativeDetailONV] PRIMARY KEY CLUSTERED ([CreativeDetailONVID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailONV_AuditTrail] ON [dbo].[CreativeDetailONV] 
...
SET @TableName = 'CreativeDetailONV'
