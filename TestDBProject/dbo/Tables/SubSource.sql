CREATE TABLE [dbo].[SubSource] (
    [SubSourceID]   INT          IDENTITY (1, 1) NOT NULL,
    [SourceID]      INT          NULL,
    [SubSourceName] VARCHAR (50) NOT NULL,
    ...
    CONSTRAINT [FK_SubSource_Source] FOREIGN KEY ([SourceID]) REFERENCES [dbo].[Source] ([SourceID])
);


GO
CREATE TRIGGER [dbo].[SubSource_AuditTrail] ON [dbo].[SubSource] 
