CREATE TABLE [dbo].[ScanTrackerSession] (
    [ScanTrackerSessionID] INT      IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [UserID]               INT      NOT NULL,
    [StartDT]              DATETIME CONSTRAINT [DF_ScanTrackerSession_StartDt] DEFAULT (getdate()) NOT NULL,
    [EndDT]                DATETIME NULL,
    CONSTRAINT [PK_ScanTrackerSession] PRIMARY KEY CLUSTERED ([ScanTrackerSessionID] ASC)
);


GO
CREATE TRIGGER [dbo].[ScanTrackerSession_AuditTrail] ON [dbo].[ScanTrackerSession] 
...
SET @TableName = 'ScanTrackerSession'
