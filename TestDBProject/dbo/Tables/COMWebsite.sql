CREATE TABLE [dbo].[COMWebsite] (
    [COMWebsiteID]     INT           NOT NULL,
    [SiteName]         VARCHAR (100) NOT NULL,
    [ParentSiteID]     INT           NOT NULL,
    [SiteUrl]          VARCHAR (255) NOT NULL,
    [MarketID]         INT           NOT NULL,
    [EthnicLanguageID] INT           NOT NULL,
    [SiteGenreID]      INT           NOT NULL,
    [CreatedDT]        DATETIME      NOT NULL,
    [CreatedByID]      INT           NOT NULL,
    [ModifiedDT]       DATETIME      NOT NULL,
    [ModifiedByID]     INT           NOT NULL,
    CONSTRAINT [PK_COMWebSitesMaster] PRIMARY KEY CLUSTERED ([COMWebsiteID] ASC)
);


GO
CREATE TRIGGER [dbo].[COMWebsite_AuditTrail] ON [dbo].[COMWebsite] 
