CREATE TABLE [dbo].[ExceptionDetail] (
    [ExceptionDetailID]      INT           IDENTITY (1, 1) NOT NULL,
    [PatternMasterStagingID] INT           NOT NULL,
    ...
    CONSTRAINT [PK_ExceptionDetails] PRIMARY KEY CLUSTERED ([ExceptionDetailID] ASC)
);


GO
CREATE TRIGGER [dbo].[ExceptionDetail_AuditTrail] ON [dbo].[ExceptionDetail] 
