CREATE TABLE [dbo].[ShipmentAssoc] (
    [ShipperID]        INT NOT NULL,
    [ShippingMethodID] INT NOT NULL,
    [PackageTypeID]    INT NOT NULL,
    CONSTRAINT [PK_ShipmentAssoc] PRIMARY KEY CLUSTERED ([ShipperID] ASC, [ShippingMethodID] ASC, [PackageTypeID] ASC)
);


GO
CREATE TRIGGER [dbo].[ShipmentAssoc_AuditTrail] ON [dbo].[ShipmentAssoc] 
