CREATE TABLE [dbo].[RadioStation] (
    ...
    [EndDT]            DATETIME     NULL,
    CONSTRAINT [PK_RadioStation_1] PRIMARY KEY CLUSTERED ([RadioStationID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_RadioStation_DMA]
    ON [dbo].[RadioStation]([Dma] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_RadioStation_RCSStationID_EffectiveDates]
    ON [dbo].[RadioStation]([RCSStationID] ASC, [EffectiveDT] ASC, [EndDT] ASC);


GO
CREATE TRIGGER [dbo].[RadioStation_AuditTrail] ON [dbo].[RadioStation] 
