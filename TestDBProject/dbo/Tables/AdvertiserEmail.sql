CREATE TABLE [dbo].[AdvertiserEmail] (
    [AdvertiserEmailID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_AdvertiserEmail1] PRIMARY KEY CLUSTERED ([AdvertiserEmailID] ASC)
);


GO
CREATE TRIGGER [dbo].[AdvertiserEmail_AuditTrail] ON [dbo].[AdvertiserEmail] 
