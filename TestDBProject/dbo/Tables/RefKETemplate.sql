CREATE TABLE [dbo].[RefKETemplate] (
    [RefKETemplateID] INT           IDENTITY (1, 1) NOT NULL,
    [Descrip]         VARCHAR (125) NOT NULL,
    [KElementLevel]   VARCHAR (50)  NOT NULL
);


GO
CREATE TRIGGER [dbo].[RefKETemplate_AuditTrail] ON [dbo].[RefKETemplate] 
