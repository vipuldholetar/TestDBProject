CREATE TABLE [dbo].[UserRoles] (
    ...
    CONSTRAINT [FK_UserRoles_Role] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[Role] ([RoleID]),
    CONSTRAINT [FK_UserRoles_User] FOREIGN KEY ([UserID]) REFERENCES [dbo].[User] ([UserID])
);


GO
CREATE TRIGGER [dbo].[UserRoles_AuditTrail] ON [dbo].[UserRoles] 
