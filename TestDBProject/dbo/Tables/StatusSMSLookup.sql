CREATE TABLE [dbo].[StatusSMSLookup] (
    [StatusSMSLookupID] INT           IDENTITY (1, 1) NOT NULL,
    [StatusText]        VARCHAR (50)  NULL,
    [StatusCode]        INT           NULL,
    [StatusDescrip]     VARCHAR (200) NULL,
    CONSTRAINT [PK_STATUS_SMS_LOOKUP] PRIMARY KEY CLUSTERED ([StatusSMSLookupID] ASC)
);


GO
CREATE TRIGGER [dbo].[StatusSMSLookup_AuditTrail] ON [dbo].[StatusSMSLookup] 
