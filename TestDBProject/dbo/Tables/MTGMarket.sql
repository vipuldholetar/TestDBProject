CREATE TABLE [dbo].[MTGMarket] (
    [MTGMarketID] INT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_MTGMarket] PRIMARY KEY CLUSTERED ([MTGMarketID] ASC)
);


GO
CREATE TRIGGER [dbo].[MTGMarket_AuditTrail] ON [dbo].[MTGMarket] 
