CREATE TABLE [dbo].[FRStatus] (
    [FRStatusID]   INT          NOT NULL,
    [Descrip]      VARCHAR (50) NOT NULL,
    [DisplayOrder] INT          NULL,
    CONSTRAINT [PK_FRStatus] PRIMARY KEY CLUSTERED ([FRStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[FRStatus_AuditTrail] ON [dbo].[FRStatus] 
