...
GO
CREATE TRIGGER [dbo].[MediaType_AuditTrail] ON [dbo].[MediaType] 
...
END
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary key in MediaType', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MediaType', @level2type = N'COLUMN', @level2name = N'MediaTypeID';
