CREATE TABLE [dbo].[RefTargetMarket] (
    [RefTargetMarketID] INT          IDENTITY (1, 1) NOT NULL,
    [Code]              VARCHAR (1)  NOT NULL,
    [Name]              VARCHAR (50) NOT NULL,
    CONSTRAINT [PK_RefTargetMarket] PRIMARY KEY CLUSTERED ([RefTargetMarketID] ASC)
);


GO
CREATE TRIGGER [dbo].[RefTargetMarket_AuditTrail] ON [dbo].[RefTargetMarket] 
