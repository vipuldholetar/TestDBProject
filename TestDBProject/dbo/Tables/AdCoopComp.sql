CREATE TABLE [dbo].[AdCoopComp] (
    [AdCoopID]     INT           NOT NULL,
    [CoopCompCode] NVARCHAR (50) NOT NULL,
    [AdvertiserID] INT           NOT NULL
);


GO
CREATE TRIGGER [dbo].[AdCoopComp_AuditTrail] ON [dbo].[AdCoopComp] 
