CREATE TABLE [dbo].[COMTimePeriod] (
    [COMTimePeriodID]   INT           NOT NULL,
    [Descrip]           VARCHAR (100) NOT NULL,
    [StartDT]           DATE          NOT NULL,
    [EndDT]             DATE          NOT NULL,
    [CreatedDT]         DATE          NOT NULL,
    [IngestionComplete] TINYINT       NOT NULL,
    [MarketID]          INT           NOT NULL,
    CONSTRAINT [PK_COMTimePeriodsMaster] PRIMARY KEY CLUSTERED ([COMTimePeriodID] ASC)
);


GO
CREATE TRIGGER [dbo].[COMTimePeriod_AuditTrail] ON [dbo].[COMTimePeriod] 
