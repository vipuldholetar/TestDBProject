CREATE TABLE [dbo].[AdvertiserTakeCount] (
    [AdvertiserTakeCountID] INT          IDENTITY (1, 1) NOT NULL,
    [WWTIndustryID]         INT          NOT NULL,
    [AdvertiserID]          INT          NOT NULL,
    [MediaStream]           VARCHAR (50) NULL,
    [PubUniverse]           VARCHAR (50) NULL,
    [LanguageID]            INT          NULL,
    [TakeCountLimit]        INT          NOT NULL,
    PRIMARY KEY CLUSTERED ([AdvertiserTakeCountID] ASC),
    CONSTRAINT [FK_AdvertiserTakeCount_To_WWTIndustryAdvertiser] FOREIGN KEY ([WWTIndustryID], [AdvertiserID]) REFERENCES [dbo].[WWTIndustryAdvertiser] ([WWTIndustryID], [AdvertiserID])
);


GO
CREATE TRIGGER [dbo].[AdvertiserTakeCount_AuditTrail] ON [dbo].[AdvertiserTakeCount] 
...
SET @TableName = 'AdvertiserTakeCount'
