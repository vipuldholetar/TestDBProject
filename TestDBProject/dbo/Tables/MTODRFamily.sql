CREATE TABLE [dbo].[MTODRFamily] (
    [MTODRFamilyID] INT            IDENTITY (1, 1) NOT NULL,
    [FamilyDescrip] VARCHAR (1000) NOT NULL,
    [CreatedDT]     DATETIME       NOT NULL,
    [CreatedByID]   INT            NOT NULL,
    [ModifiedDT]    DATETIME       NULL,
    [ModifiedByID]  INT            NULL,
    CONSTRAINT [PK_MTODFamily] PRIMARY KEY CLUSTERED ([MTODRFamilyID] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_MTODRFamily_Descrip]
    ON [dbo].[MTODRFamily]([FamilyDescrip] ASC);


GO
CREATE TRIGGER [dbo].[MTODRFamily_AuditTrail] ON [dbo].[MTODRFamily] 
