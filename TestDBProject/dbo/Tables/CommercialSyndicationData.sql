CREATE TABLE [dbo].[CommercialSyndicationData] (
    [Value] NVARCHAR (MAX) NULL
);


GO
CREATE TRIGGER [dbo].[CommercialSyndicationData_AuditTrail] ON [dbo].[CommercialSyndicationData] 
...
SET @TableName = 'CommercialSyndicationData'
