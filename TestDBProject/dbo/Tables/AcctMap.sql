CREATE TABLE [dbo].[AcctMap] (
    [AcctMapID]        INT          IDENTITY (1, 1) NOT NULL,
    [RCSAcctID]        INT          NULL,
    ...
    CONSTRAINT [PK_AcctMap] PRIMARY KEY CLUSTERED ([AcctMapID] ASC)
);


GO
CREATE TRIGGER [dbo].[AcctMap_AuditTrail] ON [dbo].[AcctMap] 
