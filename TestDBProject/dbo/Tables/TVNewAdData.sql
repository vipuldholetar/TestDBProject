CREATE TABLE [dbo].[TVNewAdData] (
    [TVNewAdDataID] INT           IDENTITY (1, 1) NOT NULL,
    [AdFileData]    VARCHAR (MAX) NOT NULL,
    CONSTRAINT [PK_TVNewAdData] PRIMARY KEY CLUSTERED ([TVNewAdDataID] ASC)
);


GO
CREATE TRIGGER [dbo].[TVNewAdData_AuditTrail] ON [dbo].[TVNewAdData] 
