CREATE TABLE [dbo].[ElementCriteria] (
    ...
    CONSTRAINT [PK_ElementCriteria] PRIMARY KEY CLUSTERED ([CriteriaID] ASC)
);


GO
CREATE TRIGGER [dbo].[ElementCriteria_AuditTrail] ON [dbo].[ElementCriteria] 
