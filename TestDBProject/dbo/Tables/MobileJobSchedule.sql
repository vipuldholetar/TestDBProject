CREATE TABLE [dbo].[MobileJobSchedule] (
    [MobileJobScheduleID]   INT         NOT NULL,
    ...
    CONSTRAINT [PK_MobileJobSchedule] PRIMARY KEY CLUSTERED ([MobileJobScheduleID] ASC)
);


GO
CREATE TRIGGER [dbo].[MobileJobSchedule_AuditTrail] ON [dbo].[MobileJobSchedule] 
...
SET @TableName = 'MobileJobSchedule'
