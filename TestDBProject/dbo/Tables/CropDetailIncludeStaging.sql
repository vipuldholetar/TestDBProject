CREATE TABLE [dbo].[CropDetailIncludeStaging] (
    [CompositeCropStagingID] INT NOT NULL,
    [ContentDetailStagingID] INT NOT NULL,
...
GO
CREATE TRIGGER [dbo].[CropDetailIncludeStaging_AuditTrail] ON [dbo].[CropDetailIncludeStaging] 
...
SET @TableName = 'CropDetailIncludeStaging'
