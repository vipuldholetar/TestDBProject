CREATE TABLE [dbo].[CropCategoryGroupStaging] (
...
GO
CREATE TRIGGER [dbo].[CropCategoryGroupStaging_AuditTrail] ON [dbo].[CropCategoryGroupStaging] 
...
SET @TableName = 'CropCategoryGroupStaging'
