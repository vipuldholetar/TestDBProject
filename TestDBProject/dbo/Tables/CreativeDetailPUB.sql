CREATE TABLE [dbo].[CreativeDetailPUB] (
    ...
    CONSTRAINT [PK_CreativeDetailPUB] PRIMARY KEY CLUSTERED ([CreativeDetailID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeDetailPUB_AuditTrail] ON [dbo].[CreativeDetailPUB] 
...
SET @TableName = 'CreativeDetailPUB'
