CREATE TABLE [dbo].[TVNationalOccurrence] (
    [TVNationalOccurrenceId] INT          IDENTITY (1, 1) NOT NULL,
    [NationalID]             INT          NULL,
    [MatchupID]              INT          NULL,
    ...
    PRIMARY KEY CLUSTERED ([TVNationalOccurrenceId] ASC)
);


GO
CREATE TRIGGER [dbo].[TVNationalOccurrence_AuditTrail] ON [dbo].[TVNationalOccurrence] 
...
SET @TableName = 'TVNationalOccurrence'
