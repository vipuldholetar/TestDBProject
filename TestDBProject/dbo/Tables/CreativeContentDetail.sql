CREATE TABLE [dbo].[CreativeContentDetail] (
    [CreativeContentDetailID] INT      IDENTITY (1, 1) NOT NULL,
    [CreativeCropID]          INT      NOT NULL,
    ...
    CONSTRAINT [PK_CreativeContentDetail] PRIMARY KEY CLUSTERED ([CreativeContentDetailID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeContentDetail_AuditTrail] ON [dbo].[CreativeContentDetail] 
...
SET @TableName = 'CreativeContentDetail'
