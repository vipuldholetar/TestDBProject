CREATE TABLE [dbo].[CreativeForCropStaging] (
    [CreativeForCropStagingID] INT            IDENTITY (1, 1) NOT NULL,
    [CreativeCropID]           INT            NULL,
    [AdID]                     INT            NOT NULL,
    [OccurrenceID]             INT            NULL,
    [CreativeMasterStagingID]  INT            NOT NULL,
    [MediaStream]              NVARCHAR (MAX) NOT NULL,
    [LockedByID]               INT            NOT NULL,
    [LockedDT]                 DATETIME       NOT NULL,
    [AdDT]                     DATETIME       NULL,
    CONSTRAINT [PK_CreativeforCropStaging] PRIMARY KEY CLUSTERED ([CreativeForCropStagingID] ASC)
);


GO
CREATE TRIGGER [dbo].[CreativeForCropStaging_AuditTrail] ON [dbo].[CreativeForCropStaging] 
...
SET @TableName = 'CreativeForCropStaging'
