CREATE TABLE [dbo].[Website] (
    ...
    [ActiveStatus]       VARCHAR (3)    NOT NULL,
    [MarketCode]         VARCHAR (4)    NOT NULL,
    [EthnicFlag]         SMALLINT       NOT NULL,
    [SpendFlag]          VARCHAR (1)    NOT NULL,
    [RedirctURL]         VARCHAR (1024) NULL,
    [TopSite]            VARCHAR (3)    NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_Website_CTLegacySEQ]
    ON [dbo].[Website]([CTLegacySeq] ASC);


GO
CREATE TRIGGER [dbo].[Website_AuditTrail] ON [dbo].[Website] 
