CREATE TABLE [dbo].[RadioStationDayPartRate] (
    [RadioStationDayPartRateID] INT      IDENTITY (1, 1) NOT NULL,
    [RCSStationID]              INT      NOT NULL,
    [RadioDayPartsID]           INT      NOT NULL,
    [Rate]                      INT      NOT NULL,
    [EffectiveDateBegin]        DATETIME NOT NULL,
    [EffectiveDateEnd]          DATETIME NOT NULL,
    [ProgramFormatID]           INT      NULL,
    [CreatedDT]                 DATETIME NOT NULL,
    [CreatedByID]               INT      NOT NULL,
    [ModifiedDT]                DATETIME NULL,
    [ModifiedByID]              INT      NULL,
    CONSTRAINT [PK_RADIOSTATIONDAYPARTSRATES] PRIMARY KEY CLUSTERED ([RadioStationDayPartRateID] ASC),
    CONSTRAINT [FK_RADIOSTATIONDAYPARTSRATES_RADIODAYPARTS] FOREIGN KEY ([RadioDayPartsID]) REFERENCES [dbo].[RadioDayPart] ([RadioDayPartID])
);


GO
CREATE TRIGGER [dbo].[RadioStationDayPartRate_AuditTrail] ON [dbo].[RadioStationDayPartRate] 
...
SET @TableName = 'RadioStationDayPartRate'
