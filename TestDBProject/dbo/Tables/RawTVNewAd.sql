CREATE TABLE [dbo].[RawTVNewAd] (
    [RawTVNewAdID]    BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RAWTVNewPatterns] PRIMARY KEY CLUSTERED ([RawTVNewAdID] ASC)
);


GO
CREATE TRIGGER [dbo].[RawTVNewAd_AuditTrail] ON [dbo].[RawTVNewAd] 
