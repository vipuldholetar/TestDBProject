CREATE TABLE [dbo].[OccurrenceDetailWEB] (
    [OccurrenceDetailWEBID] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_OccurrenceDetailsWEB] PRIMARY KEY CLUSTERED ([OccurrenceDetailWEBID] ASC),
    CONSTRAINT [FK_OccurrenceDetailsWEB_IndexStatus] FOREIGN KEY ([IndexStatusID]) REFERENCES [dbo].[IndexStatus] ([IndexStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsWEB_MapStatus] FOREIGN KEY ([MapStatusID]) REFERENCES [dbo].[MapStatus] ([MapStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsWEB_OccurrenceStatus] FOREIGN KEY ([OccurrenceStatusID]) REFERENCES [dbo].[OccurrenceStatus] ([OccurrenceStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsWEB_QCStatus] FOREIGN KEY ([QCStatusID]) REFERENCES [dbo].[QCStatus] ([QCStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsWEB_RouteStatus] FOREIGN KEY ([RouteStatusID]) REFERENCES [dbo].[RouteStatus] ([RouteStatusID]),
    CONSTRAINT [FK_OccurrenceDetailsWEB_ScanStatus] FOREIGN KEY ([ScanStatusID]) REFERENCES [dbo].[ScanStatus] ([ScanStatusID])
);


GO
CREATE TRIGGER [dbo].[OccurrenceDetailWEB_AuditTrail] ON [dbo].[OccurrenceDetailWEB] 
...
SET @TableName = 'OccurrenceDetailWEB'
