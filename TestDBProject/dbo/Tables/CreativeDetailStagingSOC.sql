CREATE TABLE [dbo].[CreativeDetailStagingSOC] (
    [CreativeDetailSOCStagingID] INT           NOT NULL,
    [CreativeStagingMasterID]    INT           NOT NULL,
    [CreativeFileType]           VARCHAR (MAX) NOT NULL,
    [CreativeRepository]         VARCHAR (MAX) NOT NULL,
    [CreativeAssetName]          VARCHAR (MAX) NOT NULL,
    [CreativeFileSize]           DECIMAL (18)  NOT NULL
);


GO
CREATE TRIGGER [dbo].[CreativeDetailStagingSOC_AuditTrail] ON [dbo].[CreativeDetailStagingSOC] 
...
SET @TableName = 'CreativeDetailStagingSOC'
