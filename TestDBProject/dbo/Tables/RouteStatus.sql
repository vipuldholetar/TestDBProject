CREATE TABLE [dbo].[RouteStatus] (
    ...
    CONSTRAINT [PK_RouteStatus] PRIMARY KEY CLUSTERED ([RouteStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[RouteStatus_AuditTrail] ON [dbo].[RouteStatus] 
