CREATE TABLE [dbo].[OccurrenceDetailCIRStatus] (
    [OccurrenceDetailCIRStatusID] INT           IDENTITY (1, 1) NOT NULL,
    [Status]                      VARCHAR (50)  NOT NULL,
    [Descrip]                     VARCHAR (100) NULL,
    CONSTRAINT [PK_OccurrenceDetailCIRStatus] PRIMARY KEY CLUSTERED ([OccurrenceDetailCIRStatusID] ASC)
);


GO
CREATE TRIGGER [dbo].[OccurrenceDetailCIRStatus_AuditTrail] ON [dbo].[OccurrenceDetailCIRStatus] 
...
SET @TableName = 'OccurrenceDetailCIRStatus'
