...
CREATE VIEW [dbo].[vw_UniversalSearchDigital]  
 with Schemabinding
As
...
and [Configuration].value in('OND','MOB') AND [PrimaryOccurrenceID] IS NOT NULL
WHERE AD.Valid = 1
...
GO
CREATE UNIQUE CLUSTERED INDEX [IDX_vw_UniversalSearchDigital]
    ON [dbo].[vw_UniversalSearchDigital]([AdID] ASC);
