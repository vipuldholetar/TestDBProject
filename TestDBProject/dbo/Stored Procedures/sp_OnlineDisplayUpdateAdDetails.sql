...
-- Description		: This Procedure is used to Updating Ad Details for Online Display
-- Execution		: sp_OnlineDisplayUpdateAdDetails
-- Updated By		: 
--================================================================================
Create PROCEDURE [dbo].[sp_OnlineDisplayUpdateAdDetails]
(
@Adid AS INT,
...
BEGIN
			...
			BEGIN CATCH 
						...
						RAISERROR ('sp_OnlineDisplayUpdateAdDetails: %d: %s',16,1,@error,@message,@lineNo);
