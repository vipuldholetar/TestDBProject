...
-- Description:  Update Admin Tool XML Config values  
 --Query : exec sp_UpdateJobStepXMLConfigs 'Empty/Value','5','10','Seconds','Database','markettrack.messenger@genpact.com','nanjundaswamy.as@genpact.com,Govardhan@genpact.com','nanjundaswamy.as@genpact.com,Govardhan@genpact.com','Yes',
...
-- Query : exec sp_UpdateJobStepXMLConfigs '6094','5','10','Seconds','Database','markettrack.messenger@genpact.com','nanjundaswamy.as@genpact.com,Govardhan@genpact.com','nanjundaswamy.as@genpact.com,Govardhan@genpact.com','Yes',
                                          ...
                                          --'0','$BatchFilePath','$DownloadPath',
                                          --'0','$BatchCount','$AssetBasePathForJPEGAndWav','$AssetBasePathForMedia'   
CREATE PROCEDURE [dbo].[sp_UpdateJobStepXMLConfigs]
(
