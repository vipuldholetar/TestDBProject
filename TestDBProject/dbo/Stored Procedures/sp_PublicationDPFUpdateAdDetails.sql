...
-- ========================================================================
CREATE PROCEDURE [dbo].[sp_PublicationDPFUpdateAdDetails] 
(
@Adid AS INT,
...
@NotakeReason AS INTEGER = null,
@Length AS INT=null,
@CreativeAssetQuality AS INT=null,
@OriginalADID AS INT=null,
...
BEGIN
	...
	SET NOCOUNT ON;
				...
				BEGIN CATCH 
						...
						RAISERROR ('sp_PublicationDPFUpdateAdDetails: %d: %s',16,1,@error,@message,@lineNo);
