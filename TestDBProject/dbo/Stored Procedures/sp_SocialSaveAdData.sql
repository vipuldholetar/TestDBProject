...
-- Description	: Adding new record into Ad table for Social
-- Updated By	: 
-- ===============================================================================================

CREATE PROCEDURE [dbo].[sp_SocialSaveAdData] 	
(
	...
	SET NOCOUNT ON;
     ...
     END TRY
			...
			BEGIN CATCH
				...
				RAISERROR ('[sp_SocialSaveAdData]: %d: %s',16,1,@error,@message,@lineNo)   ; 
