...
-- Description  : Process Scanned Files for Website

CREATE PROCEDURE [dbo].[Sp_Websitescandata] (@parameter AS XML) 
...
AS 
      ...
      BEGIN try 
       ...
       SET    creativeassetname = Cast( 
                            ...
                            SET    creativemasterid = @CreativemasterID, 
                                   ...
                                   newimagename = Cast(@CreativeDetailsWEBID AS 
  ...
  + '.' + @FileType, 
      ...
      BEGIN catch 
          ...
          RAISERROR ('Sp_Websitescandata: %d: %s',16,1,@error,@message,@lineNo) 
