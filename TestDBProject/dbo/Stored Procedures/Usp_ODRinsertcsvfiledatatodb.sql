...
-- Query :   
/* exec Usp_ODRinsertcsvfiledatatodb '15648381142',  
*/ 
-- ================================================================================================================   
CREATE PROCEDURE [dbo].[Usp_ODRinsertcsvfiledatatodb] (@ODRData 
...
AS 
  BEGIN 
      ...
      BEGIN catch 
          ...
          RAISERROR ('Usp_ODRinsertcsvfiledatatodb: %d: %s',16,1,@error,@message 
                     , 
                     @lineNo); 
