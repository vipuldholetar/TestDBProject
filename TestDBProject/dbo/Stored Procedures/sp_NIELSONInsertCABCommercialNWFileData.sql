...
-- Query :   
/*  
exec sp_NIELSONInsertCABCommercialNWFileData '',  

*/ 
-- =============================================   
CREATE PROCEDURE [dbo].[sp_NIELSONInsertCABCommercialNWFileData] (@NIELSONINGNWData dbo.NIELSONINGNWData 
readonly) 
AS 
  BEGIN 
     -- SET nocount ON; 
...
ORDER  BY HR.acnprogramcode, 
      ...
      BEGIN catch 
          ...
          RAISERROR ('sp_NIELSONInsertCABCommercialNWFileData: %d: %s',16,1,@error,@message, 
                     @lineNo 
          ); 
