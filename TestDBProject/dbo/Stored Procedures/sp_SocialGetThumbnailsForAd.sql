...
-- Execution Process:	[sp_SocialGetThumbnailsForAd] 5210
-- Updated By		:	
-- =============================================
CREATE PROCEDURE [dbo].[sp_SocialGetThumbnailsForAd]
(
@AdID AS INT
)
AS
BEGIN
		...
		BEGIN CATCH
				 DECLARE @error   INT,@message VARCHAR(4000),@lineNo  INT 
				  ...
				  RAISERROR ('sp_SocialGetThumbnailsForAd]: %d: %s',16,1,@error,@message,@lineNo); 		
		END CATCH
