...
-- Execution Process	: Sp_OnlineDisplaySaveAdData 'New Test Ad','','','',29710681,'',2,'07/13/2014','',0,147,1,91,'','','',Null,'','07/13/2014','07/13/2014','','07/13/2014','07/13/2014','07/13/2014','07/13/2014',0,'09442f2cc9d1d56d19bcbcdaa7ce690b8fae94c4',29712040   
-- Updated By			: Karunakar on 17th Nov 2015,Returning Generated Ad ID Value
--						       
-- ===========================================================================================================================   
CREATE PROCEDURE [dbo].[Sp_OnlineDisplaySaveAdData] 
(
...
AS 
  ...
  SET nocount ON; 
      BEGIN try 
          ...
          SELECT @primaryoccurrenceid = Min([OccurrenceDetailOND].[OccurrenceDetailONDID]) 
          FROM   [dbo].[OccurrenceDetailOND] 
                 INNER JOIN [CreativeStaging] 
                         ON [OccurrenceDetailOND].CreativeSignature = 
          ...
          ----Update PatternMasterID and Ad into [dbo].[OccurrenceDetailsOND]  Table       
	 ...
	 Commit Transaction  
      ...
      BEGIN catch 
          ...
          RAISERROR ('Sp_OnlineDisplaySaveAdData: %d: %s',16,1,@error,@message,@lineno );
