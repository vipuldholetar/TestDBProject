...
-- Description		: This Procedure is used to Update Ad for Online Video 
-- Updated By		: 
--					
--=====================================================================
CREATE PROCEDURE [dbo].[sp_OnlineVideoUpdateAdDetails]
(
@Adid AS INT,
...
BEGIN
			...
			BEGIN CATCH 
						...
						RAISERROR ('[sp_OnlineVideoUpdateAdDetails]: %d: %s',16,1,@error,@message,@lineNo);
