...
-- Description:  RCS Auto Indexing for "EN" usecase
-- Query : exec usp_RCSAUI_CASE_EN
-- ============================================= 

CREATE PROCEDURE [dbo].[usp_RCSAUI_CASE_EN] (@CreativeStagingID INT, 
      ...
      BEGIN try          
          ...
          IF( @AdvertiserID IS NOT NULL ) 
            BEGIN 
                ...
                --Update CreativeMasterID in PatternStaging table    
                UPDATE [Pattern] 
                ...
                --Remove record from PatternDetailsRAStaging and CreativeDetailsRAStaging which are moved to PatternStaging and CreativeMaster
