...
-- Execution :  Exec sp_CheckIfOccuranceExists 500002
-- =============================================
CREATE PROCEDURE [dbo].[sp_CheckIfOccuranceExists]
...
BEGIN
	...
	END
		...
		BEGIN CATCH
          ...
          RAISERROR ('[sp_CheckIfOccuranceExists]: %d: %s',16,1,@ERROR,@MESSAGE,@LINENO); 
		END CATCH
