...
-- Query :   
/*  
exec sp_NIELSONInsertNRTCommercialNWFileData '',  

*/ 
-- =============================================   
CREATE PROCEDURE [dbo].[sp_NIELSONInsertNRTCommercialNWFileData] (@NIELSONINGNWData dbo.NIELSONINGNWData 
readonly) 
AS 
  BEGIN 
     -- SET nocount ON; 
...
ORDER  BY HR.acnprogramcode, 
      ...
      BEGIN catch 
          ...
          RAISERROR ('sp_NIELSONInsertNRTCommercialNWFileData: %d: %s',16,1,@error,@message, 
                     @lineNo 
          ); 
